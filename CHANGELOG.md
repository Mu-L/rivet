...
## [25.4.2](https://github.com/Mu-L/rivet/compare/v25.4.1...v25.4.2) (2025-05-10)
...
* add ats prewarm to pegboard ([#1816](https://github.com/Mu-L/rivet/issues/1816)) ([691421e](https://github.com/Mu-L/rivet/commit/691421e59cc9522b06b9b52407691acd8f679146))
...
* add error screen for network issues ([#1871](https://github.com/Mu-L/rivet/issues/1871)) ([3c331a7](https://github.com/Mu-L/rivet/commit/3c331a7e35505757396f87da2863707b13e0cb9c))
...
* add tunnel cert rotation ([#1804](https://github.com/Mu-L/rivet/issues/1804)) ([66f5c63](https://github.com/Mu-L/rivet/commit/66f5c632be1f30dd9362267196c1cb9395367eb1))
* add url to actor ports ([#1811](https://github.com/Mu-L/rivet/issues/1811)) ([8a80712](https://github.com/Mu-L/rivet/commit/8a807123849bc8638613ca68a5aa957214b2c3ea))
...
* github star button ([#1851](https://github.com/Mu-L/rivet/issues/1851)) ([65a9b2e](https://github.com/Mu-L/rivet/commit/65a9b2e3e5775a1e85f15c4dd91a6345d95555cd))
...
* **hub:** actors and builds filters ([#1884](https://github.com/Mu-L/rivet/issues/1884)) ([bad6906](https://github.com/Mu-L/rivet/commit/bad6906b9bda56eef2509229f18af61a56e5dcbc))
...
* **site:** add support for intersection schemas ([#1725](https://github.com/Mu-L/rivet/issues/1725)) ([9b9e51c](https://github.com/Mu-L/rivet/commit/9b9e51c074aa8e4b04d4db11b094e36b691fb65e))
...
* use new onboarding flow when linking a device ([#1869](https://github.com/Mu-L/rivet/issues/1869)) ([5e63965](https://github.com/Mu-L/rivet/commit/5e63965e82e86790372923f8db3a95b726680ee6))
...
* **actors-sdk:** use proper binary fromat when receiving cbor data ([#1743](https://github.com/Mu-L/rivet/issues/1743)) ([acd927e](https://github.com/Mu-L/rivet/commit/acd927e4c913d2a8290eea54dcd6b1d2d2dc8095))
...
* add validation around internal_port ([#1809](https://github.com/Mu-L/rivet/issues/1809)) ([37ae0f5](https://github.com/Mu-L/rivet/commit/37ae0f5d49ab65cab98e84f930b8dc35bbbc3c69))
* add website image to header ([#1900](https://github.com/Mu-L/rivet/issues/1900)) ([cb2ce1e](https://github.com/Mu-L/rivet/commit/cb2ce1e541736e50b7fc5122ccfe4388c24cca21))
* adjust release scripts to new workflow ([#1863](https://github.com/Mu-L/rivet/issues/1863)) ([cf7f7b6](https://github.com/Mu-L/rivet/commit/cf7f7b6f3160e4983d6565b8c3d3db260f06c65c))
...
* **docker/dev-full:** force linux/amd64 for server container ([#1818](https://github.com/Mu-L/rivet/issues/1818)) ([948a1c0](https://github.com/Mu-L/rivet/commit/948a1c0f79a5f40b2ab4296c93a0179ebd722c0d))
...
* docs button ([#1858](https://github.com/Mu-L/rivet/issues/1858)) ([2b20094](https://github.com/Mu-L/rivet/commit/2b2009404b1acc9b1cdb2e8562e7fa3340d48169))
...
* fix manager log rotation ([#1806](https://github.com/Mu-L/rivet/issues/1806)) ([4e96fd7](https://github.com/Mu-L/rivet/commit/4e96fd73bc3e2e92d16ca449c285cc03fff0f06f))
...
* fix various wf bugs, ds undrain, nonreporting metric ([#1791](https://github.com/Mu-L/rivet/issues/1791)) ([4b86429](https://github.com/Mu-L/rivet/commit/4b86429f99b8d0e5f38fa70a3a3749ea9f12ac95))
...
* fix workflow listen_with_timeout history bug ([#1822](https://github.com/Mu-L/rivet/issues/1822)) ([c315617](https://github.com/Mu-L/rivet/commit/c31561791fe3167f3edb090a54bf1fd243b880c0))
...
* **hub:** blank screen when `CLAIMS_ENTITLEMENT_EXPIRED` ([#1730](https://github.com/Mu-L/rivet/issues/1730)) ([2a2bba4](https://github.com/Mu-L/rivet/commit/2a2bba483a6c89c82cb31d48deae78651240bd12))
* **hub:** build with rivet gives 404s ([#1855](https://github.com/Mu-L/rivet/issues/1855)) ([62fde8e](https://github.com/Mu-L/rivet/commit/62fde8e6cc54393a81dde8186272e9be84d49892))
...
* **hub:** failed request to rivet.gg/changelog.json causes error that blocks usage of hub ([#1731](https://github.com/Mu-L/rivet/issues/1731)) ([86924c9](https://github.com/Mu-L/rivet/commit/86924c9335705460a6450f6b7086ec2f15b8f318))
...
* links for pricing and sales ([#1845](https://github.com/Mu-L/rivet/issues/1845)) ([010d367](https://github.com/Mu-L/rivet/commit/010d367a9b3871c5dedd558012fb8f0e2739c835))
...
* **pegboard:** build with bullseye for correct glibc version ([#1823](https://github.com/Mu-L/rivet/issues/1823)) ([936bbdb](https://github.com/Mu-L/rivet/commit/936bbdb6510d2c1a2b060fbdcb015eba7dc4c5e6))
...
* **pegboard:** fix query in get_client_from_dc ([#1897](https://github.com/Mu-L/rivet/issues/1897)) ([ba82622](https://github.com/Mu-L/rivet/commit/ba8262219d4d7b0096c08308d0fbee5b36390052))
...
* periodically pull ats addr ([#1814](https://github.com/Mu-L/rivet/issues/1814)) ([dd65e86](https://github.com/Mu-L/rivet/commit/dd65e86b0e6dab62e49fb838cfddc9387ab460cc))
* promo image ([#1847](https://github.com/Mu-L/rivet/issues/1847)) ([55e7b20](https://github.com/Mu-L/rivet/commit/55e7b20d3b2efdac03578d345f852a514b428dc6))
...
* **release:** correct quotes on release please commit message ([c38d89b](https://github.com/Mu-L/rivet/commit/c38d89ba8eb6682485a1231029c6dd9d8399b0f7))
...
* remove react scan ([#1862](https://github.com/Mu-L/rivet/issues/1862)) ([2871f2b](https://github.com/Mu-L/rivet/commit/2871f2b244cb0582c4836172fdfc0d27c8ad1376))
* remove source hash from cache ([#1843](https://github.com/Mu-L/rivet/issues/1843)) ([86e5238](https://github.com/Mu-L/rivet/commit/86e5238f1366ca14dddfbbe7682767a3d4d803d9))
* remove unused workflow idxs ([#1810](https://github.com/Mu-L/rivet/issues/1810)) ([8df19e8](https://github.com/Mu-L/rivet/commit/8df19e89764c6197d09de6005aea361d544e51dc))
...
* reset recent team redirection when leaving a group ([#1873](https://github.com/Mu-L/rivet/issues/1873)) ([1a80f92](https://github.com/Mu-L/rivet/commit/1a80f92cfa7d9be2f07d226dbaa2bcebda63cd72))
...
* revert upsert query in pegboard ws ([#1831](https://github.com/Mu-L/rivet/issues/1831)) ([e4256d9](https://github.com/Mu-L/rivet/commit/e4256d91fab8fbfbb5f62a4087854575b00f7e52))
...
* **sdks/actor/runtime:** bad import path for 40_rivet_kv.d.ts ([#1819](https://github.com/Mu-L/rivet/issues/1819)) ([5c599c6](https://github.com/Mu-L/rivet/commit/5c599c645080dd1258ea4a0292f8dcf052373265))
...
* select styles and build base url ([#1867](https://github.com/Mu-L/rivet/issues/1867)) ([2dbead7](https://github.com/Mu-L/rivet/commit/2dbead7603bf5c17e4dcd693565021b09089e50a))
...
* **site:** add missing redirects to opengamebackend.org ([#1726](https://github.com/Mu-L/rivet/issues/1726)) ([d84fa85](https://github.com/Mu-L/rivet/commit/d84fa85f6550f0f1087a83f8dfe54e059b3daec4))
...
* **site:** hide dropdown when hovering over tab without dropdown ([#1727](https://github.com/Mu-L/rivet/issues/1727)) ([d9d16f7](https://github.com/Mu-L/rivet/commit/d9d16f757bbc7663180d07c2aed2c5cfa8d65873))
...
* **site:** pricing page anchors to bottom of page ([#1728](https://github.com/Mu-L/rivet/issues/1728)) ([6903892](https://github.com/Mu-L/rivet/commit/69038922002d397f3fe2e4492ad0e9e2ef9292e0))
...
* add lifecycle hooks implementation note ([#1875](https://github.com/Mu-L/rivet/issues/1875)) ([edcf200](https://github.com/Mu-L/rivet/commit/edcf2008e9683ff1823d57ff1586cc08b616af1e))
...
* **hub:** change plan names in billing badge ([#1732](https://github.com/Mu-L/rivet/issues/1732)) ([9727f21](https://github.com/Mu-L/rivet/commit/9727f216d3884f94ee438f6419caafdcb5bc7e0b))
...
* add pkg.pr.new ([#1870](https://github.com/Mu-L/rivet/issues/1870)) ([52b8aad](https://github.com/Mu-L/rivet/commit/52b8aad971bd5dfe5398f6010a9f57deeee42e4c))
...
* **api-actor:** handle no edge regions gracefully ([#2318](https://github.com/Mu-L/rivet/issues/2318)) ([97a0110](https://github.com/Mu-L/rivet/commit/97a01102e18ae5e32261066c0e87426d920523e7))
...
* **fe/deps:** update yarn.lock ([#1827](https://github.com/Mu-L/rivet/issues/1827)) ([c95e36b](https://github.com/Mu-L/rivet/commit/c95e36bab57d1617bbfef592dd65cb4db20af838))
...
* **hub:** move hub source code to rivet ([#1729](https://github.com/Mu-L/rivet/issues/1729)) ([ac89fe1](https://github.com/Mu-L/rivet/commit/ac89fe1142a303529d6ae17a5661a847aeb4bde5))
...
* **hub:** update hub ([#1835](https://github.com/Mu-L/rivet/issues/1835)) ([0db5070](https://github.com/Mu-L/rivet/commit/0db50707a9e41f27d62d05a77489d23b233e4aa6))
* improve actors allocated metric ([#1812](https://github.com/Mu-L/rivet/issues/1812)) ([46ea373](https://github.com/Mu-L/rivet/commit/46ea3738a1156b57e1030df679d3ed36b235ca35))
* improve frontend apps workflow ([#1756](https://github.com/Mu-L/rivet/issues/1756)) ([b66b5f0](https://github.com/Mu-L/rivet/commit/b66b5f03568e2809db44f89bd68cd0c7d01fe425))
...
* **js-utils:** switch from unenv to node-stdlib-browser ([#2071](https://github.com/Mu-L/rivet/issues/2071)) ([479bc55](https://github.com/Mu-L/rivet/commit/479bc557294f1b6bc446a7dceab94ce0692e43ec))
...
* **justfile:** add system test shortcut command ([#1825](https://github.com/Mu-L/rivet/issues/1825)) ([1ce6f44](https://github.com/Mu-L/rivet/commit/1ce6f440a68330ddde26aa150f203a138546feed))
...
* **main:** release 24.6.2 ([#1808](https://github.com/Mu-L/rivet/issues/1808)) ([313b24b](https://github.com/Mu-L/rivet/commit/313b24be87861acfdf6e2910832e30b80c38a7a9))
* **main:** release 24.6.2-rc.1 ([#1803](https://github.com/Mu-L/rivet/issues/1803)) ([3c51643](https://github.com/Mu-L/rivet/commit/3c516432865d2f9a6df0c8fd1cb3e3be15576b6d))
* **main:** release 24.6.2-rc.1' ([#1797](https://github.com/Mu-L/rivet/issues/1797)) ([4c3b7ce](https://github.com/Mu-L/rivet/commit/4c3b7ce5ec6b844729d1235f664d6c6311c81c6b))
...
* **mm:** handle orphaned runs without matching lobbies ([#1826](https://github.com/Mu-L/rivet/issues/1826)) ([34e333c](https://github.com/Mu-L/rivet/commit/34e333c819c3d6d3c77aabc19e514141398bf962))
...
* release 24.6.2 ([cc607c3](https://github.com/Mu-L/rivet/commit/cc607c321636eb4072c4707bb6862d3e7afedcfb))
* release 24.6.2 ([221567e](https://github.com/Mu-L/rivet/commit/221567edf18bee18caeefccb58164ef47ef5173c))
* release 24.6.2-rc.1 ([ff0c81b](https://github.com/Mu-L/rivet/commit/ff0c81b143dac1437086d4f488546ecf940524e4))
...
* release 25.2.1 ([306f48d](https://github.com/Mu-L/rivet/commit/306f48dc0abe2d4171e97b520ebfff91dc9aa7f5))
...
* **release:** update version to 24.6.2 ([a18a756](https://github.com/Mu-L/rivet/commit/a18a75650ca20c15cf6f478a712c66b6ef4045ce))
* **release:** update version to 24.6.2-rc.1 ([75efeac](https://github.com/Mu-L/rivet/commit/75efeac98a869ee6dafdf8215196f87ee7eb8587))
...
* **release:** update version to 25.2.2 ([bd72622](https://github.com/Mu-L/rivet/commit/bd726221bcef21b4d73b9e02571157bd75ceddd0))
...
* **release:** update version to 25.4.2 ([89d12ce](https://github.com/Mu-L/rivet/commit/89d12ce6fdf6a9f404d9dd271adc9e58904b2752))
* **release:** update version to 5.1.2 ([9d0bbe2](https://github.com/Mu-L/rivet/commit/9d0bbe2e6c6c6171d3f0ed1452dd401fc4976aee))
* **release:** update version to 5.1.2 ([7f92886](https://github.com/Mu-L/rivet/commit/7f92886ce6256500a0f2dc16bc00a9e9c111952b))
* **release:** update version to 5.1.3 ([6171e7f](https://github.com/Mu-L/rivet/commit/6171e7f96d04cefaa5588af07c7b384013186c33))
* remove @rivet-gg/cli from release temporarily ([08f5934](https://github.com/Mu-L/rivet/commit/08f5934028e6c54c04b52b34258c8a3d5aa4016f))
* remove `rivet init1 from readme ([93ab2f8](https://github.com/Mu-L/rivet/commit/93ab2f8950aa0659f8089581ec7114f7e45c965f))
* remove actors sdk in favor of actorcore ([#2199](https://github.com/Mu-L/rivet/issues/2199)) ([ee7693b](https://github.com/Mu-L/rivet/commit/ee7693ba7fb93b6a648f7e9e71586ad83eb6f786))
* remove init command ([#2198](https://github.com/Mu-L/rivet/issues/2198)) ([b215811](https://github.com/Mu-L/rivet/commit/b21581181f35f86f1ef8a1a0cd14c13f89038da6))
* remove jsr packages from js-utils-embed ([#1916](https://github.com/Mu-L/rivet/issues/1916)) ([ebef9f2](https://github.com/Mu-L/rivet/commit/ebef9f2598c928bed63ae700ddd61ad2ffa6871c))
* remove lefthook git hooks ([#2073](https://github.com/Mu-L/rivet/issues/2073)) ([86010d0](https://github.com/Mu-L/rivet/commit/86010d09781f4283e5123e9d89db9ded6904ea66))
* rename actor -&gt; actors in sdk for consistency ([#2197](https://github.com/Mu-L/rivet/issues/2197)) ([479ac9a](https://github.com/Mu-L/rivet/commit/479ac9a5be2b4fb77ac7a3a889fd97185e4a1cb1))
* rename actor.regions.resolve to actor.regions.recommend ([#2196](https://github.com/Mu-L/rivet/issues/2196)) ([b28003d](https://github.com/Mu-L/rivet/commit/b28003dca4f7a7701414ee7920e07fa133512fd1))
* restructure server binaries ([#1941](https://github.com/Mu-L/rivet/issues/1941)) ([7942152](https://github.com/Mu-L/rivet/commit/79421526f4cb66eafeb63b1cd0dd6e5753a487c8))
* **runtime:** add otel support to runtime ([#2085](https://github.com/Mu-L/rivet/issues/2085)) ([56a2a5e](https://github.com/Mu-L/rivet/commit/56a2a5e7de7d3273cae3e7016c679ba22c73ac52))
* **sdks/actor/client:** log rpc name on error ([#1956](https://github.com/Mu-L/rivet/issues/1956)) ([40214b4](https://github.com/Mu-L/rivet/commit/40214b47711679dc9d6853eae415cbddd401feb9))
* **sdks/actor/runtime:** make all config parameters optional recursively ([#1954](https://github.com/Mu-L/rivet/issues/1954)) ([879a0df](https://github.com/Mu-L/rivet/commit/879a0df6bc3832469c8fefb9c7c3fdcedd26ce98))
* **sdks/actor/runtime:** remove legacy version check ([#1960](https://github.com/Mu-L/rivet/issues/1960)) ([d8c9a9a](https://github.com/Mu-L/rivet/commit/d8c9a9ab88c74676f88bf634807080b0690b5cf7))
* **sdks/actor:** remove all jsr libraries ([#1915](https://github.com/Mu-L/rivet/issues/1915)) ([fcceb8d](https://github.com/Mu-L/rivet/commit/fcceb8d6daa84a51c80fa8bad907424e7d0545ba))
* **site:** improve orama searchbox ([#2034](https://github.com/Mu-L/rivet/issues/2034)) ([#2100](https://github.com/Mu-L/rivet/issues/2100)) ([d99af82](https://github.com/Mu-L/rivet/commit/d99af825eea57403e93b82cdfca4f7bffd73db75))
* switch logs query to use positionCaseInsensitive ([#2388](https://github.com/Mu-L/rivet/issues/2388)) ([c30611d](https://github.com/Mu-L/rivet/commit/c30611dbab009dd01602fdd4762df4470beba4c4))
* sync fe repo ([#1829](https://github.com/Mu-L/rivet/issues/1829)) ([df42570](https://github.com/Mu-L/rivet/commit/df4257038a5b2cc511f0c7d3b05cfca020bc01f1))
* **system-test:** add tick log every second ([#2129](https://github.com/Mu-L/rivet/issues/2129)) ([3e07944](https://github.com/Mu-L/rivet/commit/3e079444a43eb2d0d7b24d18c0132b5750828814))
* temporarily disable sentry ([#2406](https://github.com/Mu-L/rivet/issues/2406)) ([0a94837](https://github.com/Mu-L/rivet/commit/0a94837ffee0c901fd64cdafdebdacc039946b1d))
* **toolchain:** include node polyfill for unsupported standard libraries ([#1894](https://github.com/Mu-L/rivet/issues/1894)) ([9912720](https://github.com/Mu-L/rivet/commit/99127204f23bb777a89a81676e8f2ac8aa18c2c1))
* **toolchain:** switch from es2020 to esnext target ([#1955](https://github.com/Mu-L/rivet/issues/1955)) ([cfe97df](https://github.com/Mu-L/rivet/commit/cfe97df428e37cddd4c2b4f3862ebdd541c9c35a))
* **toolchain:** update default templates for npm compat ([#1914](https://github.com/Mu-L/rivet/issues/1914)) ([4266f46](https://github.com/Mu-L/rivet/commit/4266f4658465eba24cbae9e99bcd916401394efc))
* tweak clickhouse options for logs ([#2387](https://github.com/Mu-L/rivet/issues/2387)) ([c057c6a](https://github.com/Mu-L/rivet/commit/c057c6aead68c5fc4c8e0b77f925039a00d780bd))
* tweak wording for studio entrypoint ([#2308](https://github.com/Mu-L/rivet/issues/2308)) ([2326b4c](https://github.com/Mu-L/rivet/commit/2326b4ce863ce4eca99a5e292d557955859a1695))
* udpate guard websocket tests to include message sending ([#2320](https://github.com/Mu-L/rivet/issues/2320)) ([e81d2ba](https://github.com/Mu-L/rivet/commit/e81d2ba6e72ed51ca8f604045d5e5163f82ffe83))
* update apis ([#1922](https://github.com/Mu-L/rivet/issues/1922)) ([d83ab10](https://github.com/Mu-L/rivet/commit/d83ab10dc3daf138733b5dd5cf29adfe842724c6))
* update CTA ([#2247](https://github.com/Mu-L/rivet/issues/2247)) ([460969f](https://github.com/Mu-L/rivet/commit/460969fbc97771fade3b4abddccf3aa4fc6c333e))
* update dev command from start to dev ([#1967](https://github.com/Mu-L/rivet/issues/1967)) ([b88a5da](https://github.com/Mu-L/rivet/commit/b88a5da17ce607057649e1bf57c0d4e6f1b19bb1))
* update discussion links ([ebf8d6d](https://github.com/Mu-L/rivet/commit/ebf8d6d8dccbe21d521a66a0eae9923f6e6dda50))
* update discussions url ([b39c154](https://github.com/Mu-L/rivet/commit/b39c154f3164ec5b00cc1d18bd0d3c4ccbc443b5))
* update examples ([#1936](https://github.com/Mu-L/rivet/issues/1936)) ([c6ca79e](https://github.com/Mu-L/rivet/commit/c6ca79ef05332026adde1a770111b941b7bcee64))
* update generateArticle script extension to .js ([#1993](https://github.com/Mu-L/rivet/issues/1993)) ([e65b5cb](https://github.com/Mu-L/rivet/commit/e65b5cbd1b05c9b36635e66ca8b3d4f35abda4a1))
* update lockfile ([d8a5d93](https://github.com/Mu-L/rivet/commit/d8a5d9321eb1e19a845e43a3aae78a2273cd63ce))
* update package name to @rivet-gg/cli ([999431d](https://github.com/Mu-L/rivet/commit/999431d3634cc1163674e17ca6f08c7d7527e071))
* update pricing blog ([#2050](https://github.com/Mu-L/rivet/issues/2050)) ([295ba50](https://github.com/Mu-L/rivet/commit/295ba504bfa645fec897b7906996adfc22a95cc0))
* update quickstart ([#1905](https://github.com/Mu-L/rivet/issues/1905)) ([6856eda](https://github.com/Mu-L/rivet/commit/6856edadaf1ac1d5419ba88a00b0de33e16b775a))
* update readme ([#1886](https://github.com/Mu-L/rivet/issues/1886)) ([9351758](https://github.com/Mu-L/rivet/commit/9351758a5401e092e530717f472f3a4673a9bab5))
* update release please ([#2399](https://github.com/Mu-L/rivet/issues/2399)) ([626d013](https://github.com/Mu-L/rivet/commit/626d013b4754edf7cb80cb634b47bfce77d91e6b))
* update reqwest client ([#2249](https://github.com/Mu-L/rivet/issues/2249)) ([b85c995](https://github.com/Mu-L/rivet/commit/b85c9954364965776a81c0472fbd31e1d287f19d))
* update site ([#1840](https://github.com/Mu-L/rivet/issues/1840)) ([dd1781b](https://github.com/Mu-L/rivet/commit/dd1781b77f9db418a27c6f361a3a11be3513569d))
* update site ([#1893](https://github.com/Mu-L/rivet/issues/1893)) ([fda6ecb](https://github.com/Mu-L/rivet/commit/fda6ecbbce08233a1bb4e268c5c4b4dbc569abce))
* update traefik port to 9000 ([#2149](https://github.com/Mu-L/rivet/issues/2149)) ([4c41e02](https://github.com/Mu-L/rivet/commit/4c41e02c4c2a694ccbc4bee5c886a5028c136f5e))
* update w3c standard with recommendations ([#2269](https://github.com/Mu-L/rivet/issues/2269)) ([9f92cb7](https://github.com/Mu-L/rivet/commit/9f92cb7dc5de59a0b4c25e898f5bc06be56bff8d))
* update website ([#1856](https://github.com/Mu-L/rivet/issues/1856)) ([2a21415](https://github.com/Mu-L/rivet/commit/2a2141572225097a12f78e78d0b7caf3d88202c1))
* updated guide to print servers to json ([#2316](https://github.com/Mu-L/rivet/issues/2316)) ([2e061d1](https://github.com/Mu-L/rivet/commit/2e061d1601cf47bcd21c5635517856d7dfc51beb))
* updated oss friends ([#2212](https://github.com/Mu-L/rivet/issues/2212)) ([c04db5c](https://github.com/Mu-L/rivet/commit/c04db5c02be6d19787ee29fc57ea3068f6c779e1))
* Updated Pricing ([#2044](https://github.com/Mu-L/rivet/issues/2044)) ([50226fd](https://github.com/Mu-L/rivet/commit/50226fd787b7676887aabe683ff9b20ba7f125fc))
* updated site font ([#2204](https://github.com/Mu-L/rivet/issues/2204)) ([37cce55](https://github.com/Mu-L/rivet/commit/37cce55f9605638ca51e5060b2aa171b971db0b3))
* upgrade system-test to npm ([#1918](https://github.com/Mu-L/rivet/issues/1918)) ([4e9cde8](https://github.com/Mu-L/rivet/commit/4e9cde839f1e6fc0f715ad2bc65a0059f5f56b9f))
* website redesign ([#2170](https://github.com/Mu-L/rivet/issues/2170)) ([fd7fdf2](https://github.com/Mu-L/rivet/commit/fd7fdf2d8946999c6b953820c868c348ddf1f9ee))
* **workflow:** increase poll intervals ([#1990](https://github.com/Mu-L/rivet/issues/1990)) ([ea5a3ba](https://github.com/Mu-L/rivet/commit/ea5a3ba21ef98946db53b7c1277034aa6e2f0517))
* **workflows:** add gc and metrics indexes ([#1998](https://github.com/Mu-L/rivet/issues/1998)) ([1dfdc88](https://github.com/Mu-L/rivet/commit/1dfdc882b12b54ba33fe538b0e54ce6ed0acb6e5))
* **workflows:** move wf gc and metrics publish into worker ([#1943](https://github.com/Mu-L/rivet/issues/1943)) ([fe6659b](https://github.com/Mu-L/rivet/commit/fe6659b8066e739830395a3e735ee722b3121225))
* workspace typo ([15db225](https://github.com/Mu-L/rivet/commit/15db225f4f6a613626feb9c11132bef9a38dbea2))
