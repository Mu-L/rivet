...
## [24.5.2](https://github.com/Mu-L/rivet/compare/v24.5.2...v24.5.2) (2024-12-06)


### Features

* actors api ([#1228](https://github.com/Mu-L/rivet/issues/1228)) ([75bb7e2](https://github.com/Mu-L/rivet/commit/75bb7e2dbbf904d4c0fb8dcf43d5ef9691f11ca2))
* add .actor. domain for ds ([#1383](https://github.com/Mu-L/rivet/issues/1383)) ([a990a42](https://github.com/Mu-L/rivet/commit/a990a429b9b52af7bde14956e157ad589a068eae))
* add @rivet-gg/actors ([#1476](https://github.com/Mu-L/rivet/issues/1476)) ([f268644](https://github.com/Mu-L/rivet/commit/f26864433d0eea74bec9b37c32ede88f351e7b8b))
* add actor api ([#1231](https://github.com/Mu-L/rivet/issues/1231)) ([bf506f6](https://github.com/Mu-L/rivet/commit/bf506f639084182cc8c4ff3e377bc85fe292e661))
* add batch actor upgrade ([#1480](https://github.com/Mu-L/rivet/issues/1480)) ([c2558d4](https://github.com/Mu-L/rivet/commit/c2558d49a2b5b7b8a89487c2eb55d1c48aa64f30))
* add creating actor by build tags, upgrading actors ([#1388](https://github.com/Mu-L/rivet/issues/1388)) ([b1fc1aa](https://github.com/Mu-L/rivet/commit/b1fc1aa17df018c072ead3ae9dc93c8f66006fb2))
* add durability to ds ([#1364](https://github.com/Mu-L/rivet/issues/1364)) ([293be3d](https://github.com/Mu-L/rivet/commit/293be3da4ecd1e9f8b420bea707b309e95d7bd6b))
* add endpoint to fetch fdb ips ([#1355](https://github.com/Mu-L/rivet/issues/1355)) ([a99f713](https://github.com/Mu-L/rivet/commit/a99f71382684d08c57ba081a71a54b21f6c0deb7))
* add fdb driver ([#1326](https://github.com/Mu-L/rivet/issues/1326)) ([896f77a](https://github.com/Mu-L/rivet/commit/896f77a76b9ac489c8ef1e0d6a81af31321b95af))
* add fdb pool ([#1304](https://github.com/Mu-L/rivet/issues/1304)) ([3ee013b](https://github.com/Mu-L/rivet/commit/3ee013b619ea6763cb2f61f3ec5dd195b408972b))
* add hash to bootstrap ([#1168](https://github.com/Mu-L/rivet/issues/1168)) ([4b0be5f](https://github.com/Mu-L/rivet/commit/4b0be5f071b27d524c824e9b7ed4039e8354fe45))
* add internal retryability to pegboard manager ([#1300](https://github.com/Mu-L/rivet/issues/1300)) ([1845baf](https://github.com/Mu-L/rivet/commit/1845baf914ce47fc7bc77574fe30ba3d09075503))
* add json cache ([#939](https://github.com/Mu-L/rivet/issues/939)) ([7c2897a](https://github.com/Mu-L/rivet/commit/7c2897a1b5bb9cca714fa0ed915554b67fb5ebf7))
* add kv get ext, fix runtime termination ([#1324](https://github.com/Mu-L/rivet/issues/1324)) ([3179e94](https://github.com/Mu-L/rivet/commit/3179e9492979ffec3532f8422566f1ccfde8dc28))
* add metadata to actor env ([#1482](https://github.com/Mu-L/rivet/issues/1482)) ([113d334](https://github.com/Mu-L/rivet/commit/113d33479dc5915151bbcd321dee60e8abd94459))
* add pegboard isolate pooltype ([#1223](https://github.com/Mu-L/rivet/issues/1223)) ([3e685b3](https://github.com/Mu-L/rivet/commit/3e685b3752ebd3b8285d2bb176bda40642b8474c))
* add put and delete ops to kv ([#1325](https://github.com/Mu-L/rivet/issues/1325)) ([bc65b95](https://github.com/Mu-L/rivet/commit/bc65b95d378d839466664c9fff547c8516c0cc22))
* add ready_ts to servers endpoint ([#1006](https://github.com/Mu-L/rivet/issues/1006)) ([8b44a7c](https://github.com/Mu-L/rivet/commit/8b44a7c3617f6ef578b2238771a218811230f432))
* add server logs endpoint ([#1005](https://github.com/Mu-L/rivet/issues/1005)) ([a23073b](https://github.com/Mu-L/rivet/commit/a23073b5b25a9cecc8730a91005b3121e1f94ee8))
* automatically recommend region for actor creation ([#1471](https://github.com/Mu-L/rivet/issues/1471)) ([9757b15](https://github.com/Mu-L/rivet/commit/9757b1595982125fb5b80f1f8f7fc6beb3bb70ea))
* **better_uptime:** allow disabling notifications ([#923](https://github.com/Mu-L/rivet/issues/923)) ([7eb12b0](https://github.com/Mu-L/rivet/commit/7eb12b0a8898a37affc5d4c23c01ae5c75d254ae))
* **bolt:** add k9s to nix-shell ([#903](https://github.com/Mu-L/rivet/issues/903)) ([7668942](https://github.com/Mu-L/rivet/commit/7668942cbeaad0974bef8df2e2be592ea9ea073b))
* **bolt:** add lost servers list and prune commands ([#1096](https://github.com/Mu-L/rivet/issues/1096)) ([0480702](https://github.com/Mu-L/rivet/commit/04807026edb5da025177f5345189cebeb42e4c91))
* **bolt:** add workflow commands to bolt ([#1131](https://github.com/Mu-L/rivet/issues/1131)) ([a47b296](https://github.com/Mu-L/rivet/commit/a47b296939d04d204428f7ce91b68c75550d9b30))
* **bolt:** build svcs as docker containers locally ([#945](https://github.com/Mu-L/rivet/issues/945)) ([11f4258](https://github.com/Mu-L/rivet/commit/11f425878ffad357d4a1da3bfef7cd07ca8d98f4))
* **bolt:** run tests in containers ([#947](https://github.com/Mu-L/rivet/issues/947)) ([08a53e3](https://github.com/Mu-L/rivet/commit/08a53e353df3678e333f4e95c55275e2fa6dfcf5))
* **builds:** add prewarm ats for builds ([#1176](https://github.com/Mu-L/rivet/issues/1176)) ([0a269b4](https://github.com/Mu-L/rivet/commit/0a269b46e578650f7672656569bff8e703cbd9f0))
* **clusters:** add pegboard pool ([#1153](https://github.com/Mu-L/rivet/issues/1153)) ([bffa76f](https://github.com/Mu-L/rivet/commit/bffa76fa8241816911b2d8741071cd498adc0139))
* **clusters:** add pegboard pool type ([#1152](https://github.com/Mu-L/rivet/issues/1152)) ([b4a1d16](https://github.com/Mu-L/rivet/commit/b4a1d1681e392865e6641e5cb1d6ca7408ba46e1))
* **clusters:** add toggle for prebakes ([#932](https://github.com/Mu-L/rivet/issues/932)) ([09890e5](https://github.com/Mu-L/rivet/commit/09890e5e7783877d2c6bb2681a39601b1bf9e4fa))
* **clusters:** convert clusters to new workflow system ([#974](https://github.com/Mu-L/rivet/issues/974)) ([0c5558b](https://github.com/Mu-L/rivet/commit/0c5558b27e22007cec0bb547d20d4c30c96aa98f))
* **clusters:** gg monitor for better uptime ([#921](https://github.com/Mu-L/rivet/issues/921)) ([152c55b](https://github.com/Mu-L/rivet/commit/152c55b28a2a41fb57115bc706e85b91bf09642e))
* combine ops and workers into one svc type ([#957](https://github.com/Mu-L/rivet/issues/957)) ([774da5c](https://github.com/Mu-L/rivet/commit/774da5c46be49cd284379d682c1b2d31cec7c540))
* config docs ([#1499](https://github.com/Mu-L/rivet/issues/1499)) ([9485a51](https://github.com/Mu-L/rivet/commit/9485a510e602f3458ca76ce294829db79e2e5b38))
* ds input validation ([#1411](https://github.com/Mu-L/rivet/issues/1411)) ([fa26199](https://github.com/Mu-L/rivet/commit/fa2619941520aa39e7132fcd4cc9ccfafb9cb8d1))
* **ds:** add datacenters endpoint ([#1065](https://github.com/Mu-L/rivet/issues/1065)) ([32d448e](https://github.com/Mu-L/rivet/commit/32d448e55ca9013442023ebd243d963761f57aef))
* **ds:** add server create failed message ([#1068](https://github.com/Mu-L/rivet/issues/1068)) ([82daf2d](https://github.com/Mu-L/rivet/commit/82daf2db2c4cfffb8cb49ec7a1642e70b86b11f6))
* **ds:** implement pegboard dynamic server ([#1158](https://github.com/Mu-L/rivet/issues/1158)) ([149de29](https://github.com/Mu-L/rivet/commit/149de292ca8a238e77b3c849c4b8416a940a7a68))
* **ds:** rewrite dynamic servers on workflows ([#1060](https://github.com/Mu-L/rivet/issues/1060)) ([c9b5578](https://github.com/Mu-L/rivet/commit/c9b5578336588f01de4451ed56751c99db0ca82e))
* **ds:** shard server workflow in two ([#1157](https://github.com/Mu-L/rivet/issues/1157)) ([8329433](https://github.com/Mu-L/rivet/commit/83294332c45bb71512d3743bb4ab373b329a38e9))
* extend tuple system to js ([#1349](https://github.com/Mu-L/rivet/issues/1349)) ([94ac482](https://github.com/Mu-L/rivet/commit/94ac482bfaf36fa311827a2a945667e1b87ea340))
* implement topology for all pool types ([#1225](https://github.com/Mu-L/rivet/issues/1225)) ([f659729](https://github.com/Mu-L/rivet/commit/f6597290b1eaa4ebccda7c26e53b642465408b9c))
* **infra:** auto-create dev tunnel & public ip ([#979](https://github.com/Mu-L/rivet/issues/979)) ([0d82155](https://github.com/Mu-L/rivet/commit/0d821554ab4b7f072887f5b88a857c359b1d51ce))
* **infra:** enable configuring min & max cockroach pool conns ([#922](https://github.com/Mu-L/rivet/issues/922)) ([e8e7255](https://github.com/Mu-L/rivet/commit/e8e725538d53c5e317163f5ffad81ca572c871be))
* **pegboard:** add client wf ([#1143](https://github.com/Mu-L/rivet/issues/1143)) ([1589118](https://github.com/Mu-L/rivet/commit/1589118e578ec617b38971ad1abbf42f5d13e5c7))
* **pegboard:** add container runner and manager ([#1144](https://github.com/Mu-L/rivet/issues/1144)) ([799c059](https://github.com/Mu-L/rivet/commit/799c0592e44c7568fa2cb2e9b4c7261aa8e1253c))
* **pegboard:** add dc wf, refactor tier, move stuff around ([#1159](https://github.com/Mu-L/rivet/issues/1159)) ([6d7416e](https://github.com/Mu-L/rivet/commit/6d7416e3d845a4492c483d9710387b8bb953e6f6))
* **pegboard:** add gc service ([#1160](https://github.com/Mu-L/rivet/issues/1160)) ([34b391f](https://github.com/Mu-L/rivet/commit/34b391fb6e385fe85eef57164034fe5f7444cbf6))
* **pegboard:** add js builds ([#1212](https://github.com/Mu-L/rivet/issues/1212)) ([f2d04d1](https://github.com/Mu-L/rivet/commit/f2d04d1ef6a7f7f494b2120431d8114b07c7d28e))
* **pegboard:** add logs from edge ([#1255](https://github.com/Mu-L/rivet/issues/1255)) ([9d304d1](https://github.com/Mu-L/rivet/commit/9d304d1dcf14b624346a9301288657abdb696d4a))
* **pegboard:** add process monitoring, wip sqlite ([#1146](https://github.com/Mu-L/rivet/issues/1146)) ([3019a65](https://github.com/Mu-L/rivet/commit/3019a651526ba93e695b3ed398bec286205bb59a))
* **pegboard:** add ws tunnel ([#1145](https://github.com/Mu-L/rivet/issues/1145)) ([5f0085d](https://github.com/Mu-L/rivet/commit/5f0085d484b7f1f2211de015ab1d20e21ccd7cce))
* **pegboard:** create robust testing system ([#1171](https://github.com/Mu-L/rivet/issues/1171)) ([2b26b6a](https://github.com/Mu-L/rivet/commit/2b26b6ab47ac7a4ea1fec099089d5b34e9c1e02d))
* **pegboard:** get container connection e2e ([#1165](https://github.com/Mu-L/rivet/issues/1165)) ([7b93bec](https://github.com/Mu-L/rivet/commit/7b93bec0f6689db13cc656341f9580f0a8906f9e))
* **pegboard:** implement v8 isolate runner ([#1213](https://github.com/Mu-L/rivet/issues/1213)) ([dc4d97e](https://github.com/Mu-L/rivet/commit/dc4d97e5dd17c77be2d364e4268c50f8e361b9e0))
* **pegboard:** implement ws wf ([#1141](https://github.com/Mu-L/rivet/issues/1141)) ([3cfbfb5](https://github.com/Mu-L/rivet/commit/3cfbfb55505c9a06d92d8480a8de39f0cfd4a3c4))
* **pegboard:** integrate setup scripts ([#1147](https://github.com/Mu-L/rivet/issues/1147)) ([cd85660](https://github.com/Mu-L/rivet/commit/cd85660e27225c1ab72126f4cd1df9de4b0964be))
* **pegboard:** make protocol more robust, implement db sync ([#1148](https://github.com/Mu-L/rivet/issues/1148)) ([166991e](https://github.com/Mu-L/rivet/commit/166991e4613b0516c1fe9378d09f594e528cf449))
* port auth for ds ([#1294](https://github.com/Mu-L/rivet/issues/1294)) ([f42c814](https://github.com/Mu-L/rivet/commit/f42c8140e96429b4472a542ef6ab9b5f8439a327))
* **runtime:** switch from json to logfmt ([#984](https://github.com/Mu-L/rivet/issues/984)) ([10a0e6c](https://github.com/Mu-L/rivet/commit/10a0e6cd6134554dfd150b34e808a2bb386ea4da))
* **svc:** add servers create endpoint ([#740](https://github.com/Mu-L/rivet/issues/740)) ([77f1b3f](https://github.com/Mu-L/rivet/commit/77f1b3f1f37199553a20f53917638b7e0e68ded5))
* update billing to use tiers ([#900](https://github.com/Mu-L/rivet/issues/900)) ([918038a](https://github.com/Mu-L/rivet/commit/918038a02a995f7eea73910181bc1adf61cac0ff))
* **workflows, clusters:** add workflow backfill service ([#1000](https://github.com/Mu-L/rivet/issues/1000)) ([e69b767](https://github.com/Mu-L/rivet/commit/e69b76791b7b59b6f7599a6110ff288d16e3652f))
* **workflows:** add api ctx for workflows ([#865](https://github.com/Mu-L/rivet/issues/865)) ([1a468d3](https://github.com/Mu-L/rivet/commit/1a468d3cd62c902c927b482e79c1469091c8f5f9))
* **workflows:** add loops ([#1001](https://github.com/Mu-L/rivet/issues/1001)) ([272a09d](https://github.com/Mu-L/rivet/commit/272a09d627614e86a71483183dd82c64e180b277))
* **workflows:** add message and signal history ([#987](https://github.com/Mu-L/rivet/issues/987)) ([0003acc](https://github.com/Mu-L/rivet/commit/0003acc30b9719691a6c29b6cff0f1dfc6283b8a))
* **workflows:** add messages ([#977](https://github.com/Mu-L/rivet/issues/977)) ([38c1171](https://github.com/Mu-L/rivet/commit/38c1171caea473eca5c8fadda662c67121e4a90a))
* **workflows:** add metrics ([#1008](https://github.com/Mu-L/rivet/issues/1008)) ([a4837e2](https://github.com/Mu-L/rivet/commit/a4837e261287b65186200674b4d621e1fb3fe2b1))
* **workflows:** add nats worker wake ([#1039](https://github.com/Mu-L/rivet/issues/1039)) ([1fc72f1](https://github.com/Mu-L/rivet/commit/1fc72f150f6c64cae08ecfa9a5a1e86b8974efd6))
* **workflows:** add observe workflows fn ([#901](https://github.com/Mu-L/rivet/issues/901)) ([22a1ebd](https://github.com/Mu-L/rivet/commit/22a1ebd5f27926ca5c6eaeddd8fa2818e0c5cf3d))
* **workflows:** add operations service type ([#898](https://github.com/Mu-L/rivet/issues/898)) ([0a0d377](https://github.com/Mu-L/rivet/commit/0a0d377a7bc2cfda92848beae454b596cdd4bc2b))
* **workflows:** add sleep fn ([#1077](https://github.com/Mu-L/rivet/issues/1077)) ([c477ba9](https://github.com/Mu-L/rivet/commit/c477ba942a84b0904b4a4facf96ce73c7813d1e7))
* **workflows:** add tags ([#956](https://github.com/Mu-L/rivet/issues/956)) ([36494eb](https://github.com/Mu-L/rivet/commit/36494ebd826477ff9a5732a37e290f208a60e3d1))
* **workflows:** add workflow migrations ([#1203](https://github.com/Mu-L/rivet/issues/1203)) ([763036a](https://github.com/Mu-L/rivet/commit/763036a5758e68618f52f64b626d601b603d8495))
* **workflows:** allow changing tags in workflow ([#962](https://github.com/Mu-L/rivet/issues/962)) ([01ecf86](https://github.com/Mu-L/rivet/commit/01ecf860783ad06fef5411722fb8ea217b23b620))
* **workflows:** clean up dispatching syntax ([#1079](https://github.com/Mu-L/rivet/issues/1079)) ([233efcc](https://github.com/Mu-L/rivet/commit/233efcc2df179e2e1a8b456b14eb9116253fe1aa))
* **workflows:** implement listen with timeout ([#1156](https://github.com/Mu-L/rivet/issues/1156)) ([4ed45c4](https://github.com/Mu-L/rivet/commit/4ed45c4947f8835c30a746a95558e7f0cf28d2b3))
* **workflows:** implement retry backoff for activity errors ([#999](https://github.com/Mu-L/rivet/issues/999)) ([6e8560e](https://github.com/Mu-L/rivet/commit/6e8560ede591c475212eb336933a307e7541721e))


### Bug Fixes

* add cluster description to pegboard client config ([#1461](https://github.com/Mu-L/rivet/issues/1461)) ([ddb8a99](https://github.com/Mu-L/rivet/commit/ddb8a993d47677f49cd4975f277575b4c233ff40))
* add disk limit to pb actors, fix dockerfiles ([#1469](https://github.com/Mu-L/rivet/issues/1469)) ([e020054](https://github.com/Mu-L/rivet/commit/e020054d9c9190ac2e6d152095f82c2deadb20e9))
* add fdb to shell nix ([#1391](https://github.com/Mu-L/rivet/issues/1391)) ([bc26c62](https://github.com/Mu-L/rivet/commit/bc26c6271e93dc8283e95194c65088735bad49de))
* add hosts file to runc ([#1386](https://github.com/Mu-L/rivet/issues/1386)) ([76089bb](https://github.com/Mu-L/rivet/commit/76089bba6fa692442daccd67a70d4ac9df35d766))
* add ip whitelist to tunnels ([#930](https://github.com/Mu-L/rivet/issues/930)) ([88ce4b3](https://github.com/Mu-L/rivet/commit/88ce4b3313a812d2ef80e7db13eb371c05bc25c3))
* add lost state for pb actors ([#1378](https://github.com/Mu-L/rivet/issues/1378)) ([8baec56](https://github.com/Mu-L/rivet/commit/8baec56a164d8abc407d0570405d9be659fa0a1c))
* add opt auth to actors ([#1321](https://github.com/Mu-L/rivet/issues/1321)) ([0069899](https://github.com/Mu-L/rivet/commit/006989998ba09ca9e6229a1051b3af72ba0367a9))
* add players and servers db indexes ([#960](https://github.com/Mu-L/rivet/issues/960)) ([53dc398](https://github.com/Mu-L/rivet/commit/53dc3981f3bc53bb7d2dbe9ccc73afdeccef5318))
* add priority class to nats ([#1019](https://github.com/Mu-L/rivet/issues/1019)) ([954d864](https://github.com/Mu-L/rivet/commit/954d864a903574a419d8c896c6e0f64c9c0ebcf8))
* add protoc to shell.nix ([#1463](https://github.com/Mu-L/rivet/issues/1463)) ([76dad38](https://github.com/Mu-L/rivet/commit/76dad38c2eb7dde631b538c4f59f7be27d8f88d6))
* add shell nix ([#1382](https://github.com/Mu-L/rivet/issues/1382)) ([eaee5a5](https://github.com/Mu-L/rivet/commit/eaee5a54741843a6630262c9aab5a455585577a9))
* add toggle for actor fs mounts ([#1478](https://github.com/Mu-L/rivet/issues/1478)) ([dea5633](https://github.com/Mu-L/rivet/commit/dea563372af6502a6d91f4a4b81871c743b8d181))
* add toolchain schema to docs ([#1527](https://github.com/Mu-L/rivet/issues/1527)) ([ce7f63c](https://github.com/Mu-L/rivet/commit/ce7f63ced687663a8e2eb65680a806449e5bf5cf))
* allocation sizes for nomad ([#1127](https://github.com/Mu-L/rivet/issues/1127)) ([2e3217e](https://github.com/Mu-L/rivet/commit/2e3217edf975cfc8c0cbc035f3ada92c2641b610))
* allow using service tokens for actor endpoints ([#1495](https://github.com/Mu-L/rivet/issues/1495)) ([eee4dea](https://github.com/Mu-L/rivet/commit/eee4dea438d85c56061f54b5da3cb9af8aec262e))
* **api:** move cors verification to endpoint level ([#1094](https://github.com/Mu-L/rivet/issues/1094)) ([4a4b4fe](https://github.com/Mu-L/rivet/commit/4a4b4feb94fca4ddc1a8c06963653b70e91138d9))
* artifact dockerfile, tokio versions ([#1232](https://github.com/Mu-L/rivet/issues/1232)) ([d5e44c5](https://github.com/Mu-L/rivet/commit/d5e44c56be9d2aa2b5c8184b6598300f5dcd4980))
* backfill script, crdb usage type ([#1089](https://github.com/Mu-L/rivet/issues/1089)) ([ad0a260](https://github.com/Mu-L/rivet/commit/ad0a260ea4de6d42f368dc129011fea1d6ff73d1))
* **better_uptime:** handle null verify_ssl ([#950](https://github.com/Mu-L/rivet/issues/950)) ([e9d8edb](https://github.com/Mu-L/rivet/commit/e9d8edbf220690788cb207e8ecb422902f42079c))
* **bolt:** add forwarded and persistent db shells ([#1130](https://github.com/Mu-L/rivet/issues/1130)) ([f9b6707](https://github.com/Mu-L/rivet/commit/f9b6707888e34a7ea9564a79a05024434e80610f))
* **bolt:** correctly hash untracked files ([#1047](https://github.com/Mu-L/rivet/issues/1047)) ([2b885e5](https://github.com/Mu-L/rivet/commit/2b885e536f6f4906d1ae875ce2708871f229415b))
* **bolt:** exclude volumes when using native docker builder ([#969](https://github.com/Mu-L/rivet/issues/969)) ([8ac0a55](https://github.com/Mu-L/rivet/commit/8ac0a55776c2a648527d9f9562ecc2077f03f3a4))
* **bolt:** explicitly handle no nomad leader error ([#971](https://github.com/Mu-L/rivet/issues/971)) ([20822fc](https://github.com/Mu-L/rivet/commit/20822fcc6f780f298f472dc2871670ababf06c10))
* **bolt:** fix wf commands sql connection on distributed clusters, add errors to history command ([#1197](https://github.com/Mu-L/rivet/issues/1197)) ([0ef9611](https://github.com/Mu-L/rivet/commit/0ef961143e6ec988db381f286e4991b418239bca))
* **bolt:** require --all flag when not using filters for cluster commands ([#1162](https://github.com/Mu-L/rivet/issues/1162)) ([b140971](https://github.com/Mu-L/rivet/commit/b140971460f13185567c8a4151f9390080e57c10))
* **bolt:** update opengb -&gt; backend env var name ([#1058](https://github.com/Mu-L/rivet/issues/1058)) ([4250808](https://github.com/Mu-L/rivet/commit/425080859e102e1af61f176e9f8290a5a0ca6e77))
* **bolt:** validate hub regex in ns config ([#1093](https://github.com/Mu-L/rivet/issues/1093)) ([b2d5cca](https://github.com/Mu-L/rivet/commit/b2d5ccae34172a5f887f9740e7bef2ef6f51c942))
* **bolt:** wait for service monitor crd ([#1202](https://github.com/Mu-L/rivet/issues/1202)) ([17cfd73](https://github.com/Mu-L/rivet/commit/17cfd7333e71860da320cb6f2147a67eae6511dc))
* **builds:** allow null tags ([#1177](https://github.com/Mu-L/rivet/issues/1177)) ([1c75e3b](https://github.com/Mu-L/rivet/commit/1c75e3b68af0347bd457cdda4d6efb6eac073434))
* **builds:** fix exclusive tags query ([#1173](https://github.com/Mu-L/rivet/issues/1173)) ([b8c323a](https://github.com/Mu-L/rivet/commit/b8c323aa725d7d7a1450e5fb72c8654ea7ed93b7))
* **cache:** mixed values in Cache::fetch_all ([#927](https://github.com/Mu-L/rivet/issues/927)) ([d69a072](https://github.com/Mu-L/rivet/commit/d69a0727019fa512ee686993ab7344168d44e006))
* **captcha:** sanitize form body ([#1098](https://github.com/Mu-L/rivet/issues/1098)) ([9b56efc](https://github.com/Mu-L/rivet/commit/9b56efca740500711966d9599614046fea4bd867))
* change ints to timestamps in actor api ([#1483](https://github.com/Mu-L/rivet/issues/1483)) ([0bd4953](https://github.com/Mu-L/rivet/commit/0bd4953275cc63116ca2b747c798a3cfadd357e2))
* **chirp:** write message tail when history is disabled ([#997](https://github.com/Mu-L/rivet/issues/997)) ([9f377ba](https://github.com/Mu-L/rivet/commit/9f377bacf49979f65154f2a370844e8fca263890))
* **cloud:** add clean timeout for matchmaker logs ([#942](https://github.com/Mu-L/rivet/issues/942)) ([a395e3f](https://github.com/Mu-L/rivet/commit/a395e3f0e432b10d670a8cef4a488c125bb177d0))
* **cluster:** dc-get column mismatch ([#958](https://github.com/Mu-L/rivet/issues/958)) ([53e276a](https://github.com/Mu-L/rivet/commit/53e276abcd403b6460e06da7fada6ee92165f3fd))
* **cluster:** dns creation ([#1066](https://github.com/Mu-L/rivet/issues/1066)) ([1ef72e6](https://github.com/Mu-L/rivet/commit/1ef72e6f544efcf0b53b0c1ceacca3180e748d2a))
* **clusters:** add drain padding to nomad ([#1100](https://github.com/Mu-L/rivet/issues/1100)) ([01ee21b](https://github.com/Mu-L/rivet/commit/01ee21b5da0b46b8aa2356ced8af3b6d9966ba7e))
* **clusters:** add network_out metrics for hardware ([#1016](https://github.com/Mu-L/rivet/issues/1016)) ([30d15c3](https://github.com/Mu-L/rivet/commit/30d15c32f5a9000877be17d1aba95a12af959057))
* **clusters:** allow dns deletion when draining and tainted ([#1132](https://github.com/Mu-L/rivet/issues/1132)) ([c808d08](https://github.com/Mu-L/rivet/commit/c808d08df13083d292399d516a5cf080f8a622ca))
* **clusters:** backfill json columns ([#1015](https://github.com/Mu-L/rivet/issues/1015)) ([2292103](https://github.com/Mu-L/rivet/commit/229210306e72dbdd7251ecdfdbba5add03693689))
* **clusters:** continue provisioning a server even when marked for deletion ([#924](https://github.com/Mu-L/rivet/issues/924)) ([8b551f4](https://github.com/Mu-L/rivet/commit/8b551f4ebbb1f1bb20612bc840fa9953fb684c84))
* **clusters:** dont delete servers immediately with linode ([#1040](https://github.com/Mu-L/rivet/issues/1040)) ([6142837](https://github.com/Mu-L/rivet/commit/61428379ef01aaf29f59bd52c044f748108d8aaa))
* **clusters:** fix backfill signal names ([#1086](https://github.com/Mu-L/rivet/issues/1086)) ([2c8ae1c](https://github.com/Mu-L/rivet/commit/2c8ae1c7fbc056fe838f90ee4b29f70d26123d63))
* **clusters:** fix dc scale job downscale logic, prebake disk waiting ([#1078](https://github.com/Mu-L/rivet/issues/1078)) ([bda60e0](https://github.com/Mu-L/rivet/commit/bda60e0ed0fbcf7b81a264c659ca299f7ec46a14))
* **clusters:** fix dns and unrecoverable error bugs ([#1083](https://github.com/Mu-L/rivet/issues/1083)) ([273e5a3](https://github.com/Mu-L/rivet/commit/273e5a332f9ce82d5c46c17d08916a0b6b19b5ef))
* **clusters:** fix linode cleanup logic ([#1034](https://github.com/Mu-L/rivet/issues/1034)) ([f7d021c](https://github.com/Mu-L/rivet/commit/f7d021ccecdd6d25966126e0bed91c58ec5179ee))
* **clusters:** fix linode-gc query ([#1063](https://github.com/Mu-L/rivet/issues/1063)) ([eb0223c](https://github.com/Mu-L/rivet/commit/eb0223cb1a479ab87116ab3b93e18f8f3569902e))
* **clusters:** fix list lost op ([#1110](https://github.com/Mu-L/rivet/issues/1110)) ([8ae85d2](https://github.com/Mu-L/rivet/commit/8ae85d29e8fce11ed62a935f0de0119e36770589))
* **clusters:** fix tls renew query ([#1026](https://github.com/Mu-L/rivet/issues/1026)) ([81a7b7a](https://github.com/Mu-L/rivet/commit/81a7b7a58273d0021ca0e366bf42de107c5a5e80))
* **clusters:** fix trafficserver run dir permissions on reboot ([#1021](https://github.com/Mu-L/rivet/issues/1021)) ([746198b](https://github.com/Mu-L/rivet/commit/746198bf84bbc636306eae9bedb8a8e51e5fad8f))
* **clusters:** fix vlan ip query ([#911](https://github.com/Mu-L/rivet/issues/911)) ([0ab1ec9](https://github.com/Mu-L/rivet/commit/0ab1ec9faba864b4ab527da8cd7ff89556ebfbcf))
* **clusters:** gracefully handle node not found ([#1099](https://github.com/Mu-L/rivet/issues/1099)) ([b460374](https://github.com/Mu-L/rivet/commit/b4603749ad711e3baa7bdcb482b255c4c01e3dcf))
* **cluster:** skip pruning servers without provider server id ([#1133](https://github.com/Mu-L/rivet/issues/1133)) ([ca43432](https://github.com/Mu-L/rivet/commit/ca43432fae665a98f0efbecf88013c6985ebb9f3))
* **cluster:** split up backfill query from schema change ([#1023](https://github.com/Mu-L/rivet/issues/1023)) ([4987029](https://github.com/Mu-L/rivet/commit/4987029cab47ed7f5f903b5ade1c4c03cae3ee7b))
* **clusters:** query vlan ips per datacenter ([#961](https://github.com/Mu-L/rivet/issues/961)) ([c2a7e3f](https://github.com/Mu-L/rivet/commit/c2a7e3f707346ac5d0bc27a8d72a65066500273f))
* **clusters:** remove nomad drain complete signal ([#1101](https://github.com/Mu-L/rivet/issues/1101)) ([c117224](https://github.com/Mu-L/rivet/commit/c117224484b49070213fc3c2f98a2d399c097dc9))
* **clusters:** resolve ip by create ts ([#1037](https://github.com/Mu-L/rivet/issues/1037)) ([7033c6e](https://github.com/Mu-L/rivet/commit/7033c6e4e68cf8154acf7fea08644b37dd67d58b))
* **clusters:** run scale workflow instead of signal ([#1041](https://github.com/Mu-L/rivet/issues/1041)) ([cbe6f89](https://github.com/Mu-L/rivet/commit/cbe6f89e974ea81ab84d6c0876414bf392b8f546))
* **clusters:** switch from drain to ineligible system ([#1102](https://github.com/Mu-L/rivet/issues/1102)) ([09f5143](https://github.com/Mu-L/rivet/commit/09f5143ea94c199ee006b9051e4c97ebc53d70bd))
* **clusters:** update pools in dc-update ([#959](https://github.com/Mu-L/rivet/issues/959)) ([9b31345](https://github.com/Mu-L/rivet/commit/9b3134583cd9063f26861d5ec275687544b244a6))
* conditionally remove cluster & ds code dependent on external providers ([#1328](https://github.com/Mu-L/rivet/issues/1328)) ([fdae5a4](https://github.com/Mu-L/rivet/commit/fdae5a4a83d28bf955643e57e70d772a621f8ac5))
* configure sqlite defaults, add txn for events ([#1379](https://github.com/Mu-L/rivet/issues/1379)) ([78877a6](https://github.com/Mu-L/rivet/commit/78877a67d9cc64ac18ae54512efbbe4fde9c2e96))
* configure systemd priorities ([#1384](https://github.com/Mu-L/rivet/issues/1384)) ([7639d46](https://github.com/Mu-L/rivet/commit/7639d460d39475587261d213336d4befde70138b))
* correct actor-core symlink ([#1481](https://github.com/Mu-L/rivet/issues/1481)) ([b63ae81](https://github.com/Mu-L/rivet/commit/b63ae81be481dbbc95f13d2e75b5ff58f6dbef94))
* correctly substitute VITE_APP_API_URL ([#1320](https://github.com/Mu-L/rivet/issues/1320)) ([3e68aee](https://github.com/Mu-L/rivet/commit/3e68aee6697fb9d01b71603ba799682335336b92))
* default resources for isolates ([#1496](https://github.com/Mu-L/rivet/issues/1496)) ([1d5652c](https://github.com/Mu-L/rivet/commit/1d5652c2d3158c6c8d8103a45a5ec5884416d2ba))
* disable eval for isolates ([#1404](https://github.com/Mu-L/rivet/issues/1404)) ([959002e](https://github.com/Mu-L/rivet/commit/959002ea7c8ad49548c39f99432bc137e9746d55))
* disable job migrations and reschedules ([#1017](https://github.com/Mu-L/rivet/issues/1017)) ([91e869d](https://github.com/Mu-L/rivet/commit/91e869d880aad745afcbf09a13141ec7b83ca6e3))
* dont return bool from kv delete ([#1434](https://github.com/Mu-L/rivet/issues/1434)) ([b67e5dc](https://github.com/Mu-L/rivet/commit/b67e5dc612d2bacf6c07d9542a6c5129645567a3))
* **ds, mm:** hard code disk per core ([#1134](https://github.com/Mu-L/rivet/issues/1134)) ([5ee2809](https://github.com/Mu-L/rivet/commit/5ee28094409aa4a620d8caff4df739f3fd08381b))
* **ds:** add back allocation signal ([#1069](https://github.com/Mu-L/rivet/issues/1069)) ([453a19b](https://github.com/Mu-L/rivet/commit/453a19b00d391085d93adb9fe16bc14e879f3f31))
* **ds:** add back runc cleanup ([#1172](https://github.com/Mu-L/rivet/issues/1172)) ([8e08889](https://github.com/Mu-L/rivet/commit/8e0888933c9d4481863df0e6b9677089c2f1b73c))
* **ds:** cache traefik routes ([#1081](https://github.com/Mu-L/rivet/issues/1081)) ([4b3a1ab](https://github.com/Mu-L/rivet/commit/4b3a1ab3737916bbbfa82df305c37fcf5ac32c1d))
* **ds:** change nomad prefix ([#1113](https://github.com/Mu-L/rivet/issues/1113)) ([705a470](https://github.com/Mu-L/rivet/commit/705a470cbdb6a21bd21209445d4c507b2e39356e))
* **ds:** disable retries for nomad monitors ([#1091](https://github.com/Mu-L/rivet/issues/1091)) ([945b5bb](https://github.com/Mu-L/rivet/commit/945b5bbd244394c33484578d6b3520fbaec76230))
* **ds:** fix destroy query ([#1067](https://github.com/Mu-L/rivet/issues/1067)) ([f67150f](https://github.com/Mu-L/rivet/commit/f67150fa3581f6ba2def9aaa64e74325c840deb6))
* **ds:** fix ds tests, traefik, nomad monitors, job server drain ([#1085](https://github.com/Mu-L/rivet/issues/1085)) ([d29bb3f](https://github.com/Mu-L/rivet/commit/d29bb3fb1b0c9c0a1d978b0b8a5cc8dd8065df16))
* **ds:** fix logs ([#1074](https://github.com/Mu-L/rivet/issues/1074)) ([21dbd6c](https://github.com/Mu-L/rivet/commit/21dbd6c5109d1440b4ec0bcc510b439bb108f1e2))
* **ds:** fix server list & nomad monitor alloc plan queries ([#1071](https://github.com/Mu-L/rivet/issues/1071)) ([eb0252c](https://github.com/Mu-L/rivet/commit/eb0252cd7314c66ecefdc710e58f0bc64f74616b))
* **ds:** fix servers ([#1061](https://github.com/Mu-L/rivet/issues/1061)) ([4e8185b](https://github.com/Mu-L/rivet/commit/4e8185b5cb89cd9c609d2263c382cd00090b0a7d))
* **ds:** implement nomad monitors with signals ([#1105](https://github.com/Mu-L/rivet/issues/1105)) ([238a8e9](https://github.com/Mu-L/rivet/commit/238a8e98d5dd561fd442866f59862777e0e68b56))
* **ds:** remove reschedule block ([#1082](https://github.com/Mu-L/rivet/issues/1082)) ([4488c74](https://github.com/Mu-L/rivet/commit/4488c74d5e41b9f6fe8282f2bfdc3095256e989a))
* **ds:** update auth endpoints ([#1044](https://github.com/Mu-L/rivet/issues/1044)) ([11416c4](https://github.com/Mu-L/rivet/commit/11416c44155d11248b2779eaa2d6f0ed295c8ed0))
* enable host networking and root users on dev ([#1387](https://github.com/Mu-L/rivet/issues/1387)) ([a8ef10e](https://github.com/Mu-L/rivet/commit/a8ef10e91474253501e56f8372232c6a30a1823d))
* fix api url parsing, pegboard install ([#1240](https://github.com/Mu-L/rivet/issues/1240)) ([b420f2e](https://github.com/Mu-L/rivet/commit/b420f2e1c709673274cefff22ab77d27aaf0799f))
* fix build tags ([#1190](https://github.com/Mu-L/rivet/issues/1190)) ([6e2d214](https://github.com/Mu-L/rivet/commit/6e2d2148b595f3ebcd3f12bc34e67c1af432e643))
* fix build validation ([#1448](https://github.com/Mu-L/rivet/issues/1448)) ([c647e41](https://github.com/Mu-L/rivet/commit/c647e41fe5e7c3967f8bacf1e498d86daedd8104))
* fix cargo tomls ([#1428](https://github.com/Mu-L/rivet/issues/1428)) ([d8be291](https://github.com/Mu-L/rivet/commit/d8be291372b22a5aff76bd2cc511ef70891890bf))
* fix clickhouse health check ([#1395](https://github.com/Mu-L/rivet/issues/1395)) ([725c794](https://github.com/Mu-L/rivet/commit/725c794080fd94774b5550e522f9e7044ec71445))
* fix compile errors in manager ([#1291](https://github.com/Mu-L/rivet/issues/1291)) ([062a85b](https://github.com/Mu-L/rivet/commit/062a85b68044bbc832d5806f07e0d5ace2310b7f))
* fix documentation link for errors ([#1174](https://github.com/Mu-L/rivet/issues/1174)) ([eb7fdaf](https://github.com/Mu-L/rivet/commit/eb7fdaff5ac63f1bed9d01db9b04d24ef0d969e3))
* fix ds echo build ([#1032](https://github.com/Mu-L/rivet/issues/1032)) ([ad1146e](https://github.com/Mu-L/rivet/commit/ad1146e1fafe38c8861e650780a11392893ff9f0))
* fix dynamic config query ([#1276](https://github.com/Mu-L/rivet/issues/1276)) ([96155e2](https://github.com/Mu-L/rivet/commit/96155e2d504d4f20ffbb8c68d7e4a5f0fe9b4f3e))
* fix event sending race condition for pb manager ([#1455](https://github.com/Mu-L/rivet/issues/1455)) ([0e2642a](https://github.com/Mu-L/rivet/commit/0e2642aef3ae5eb48717c81b2759bfa5090ad1bd))
* fix global query deserialize ([#1313](https://github.com/Mu-L/rivet/issues/1313)) ([f45c1d0](https://github.com/Mu-L/rivet/commit/f45c1d07092391a66dcf40b4b18c2d583ac6e307))
* fix indexes for wf driver ([#1226](https://github.com/Mu-L/rivet/issues/1226)) ([46389aa](https://github.com/Mu-L/rivet/commit/46389aa6d543394477f76b49b2f7bed90bdcb730))
* fix infra artifacts dockerfiles, wf commands ([#1252](https://github.com/Mu-L/rivet/issues/1252)) ([dcf5b03](https://github.com/Mu-L/rivet/commit/dcf5b031c5e41e1b0bb94422da7ac33968076fa6))
* fix js glue ([#1477](https://github.com/Mu-L/rivet/issues/1477)) ([496d9dc](https://github.com/Mu-L/rivet/commit/496d9dca5fe16f67b6806a9780af6fc0655277fc))
* fix legacy bolt get ([#1193](https://github.com/Mu-L/rivet/issues/1193)) ([68285cb](https://github.com/Mu-L/rivet/commit/68285cb271b0fabd49ddb8bad9f75aa8fcd3faff))
* fix merge ([#1380](https://github.com/Mu-L/rivet/issues/1380)) ([93710fc](https://github.com/Mu-L/rivet/commit/93710fc7c0c194b712af40327b54364d4b350280))
* fix monolith welcome message ([#1413](https://github.com/Mu-L/rivet/issues/1413)) ([4eedc91](https://github.com/Mu-L/rivet/commit/4eedc91a8ee8a8817c1e867414185bef329d0f21))
* fix multiple patching exclusive tags ([#1498](https://github.com/Mu-L/rivet/issues/1498)) ([62d5dc9](https://github.com/Mu-L/rivet/commit/62d5dc96f0391e5d2c654a7afe19eca756918f77))
* fix patch build tags ([#1486](https://github.com/Mu-L/rivet/issues/1486)) ([8482e28](https://github.com/Mu-L/rivet/commit/8482e283cd8fef783a055e85aa1cddbf40e6baac))
* fix pb manager receive error ([#1323](https://github.com/Mu-L/rivet/issues/1323)) ([02d73b6](https://github.com/Mu-L/rivet/commit/02d73b62ad5ddd2fbeb5cdc2c4f5c4819ed4fd4c))
* fix pegboard tests ([#1297](https://github.com/Mu-L/rivet/issues/1297)) ([a9a1983](https://github.com/Mu-L/rivet/commit/a9a1983608c8e748c500398c1d9ee2a96ff2cc2a))
* fix port auth sql ([#1296](https://github.com/Mu-L/rivet/issues/1296)) ([688f76a](https://github.com/Mu-L/rivet/commit/688f76a7b84999a2db579500b330f82d274c2c5c))
* fix signal history divergence ([#1115](https://github.com/Mu-L/rivet/issues/1115)) ([3cbfc1b](https://github.com/Mu-L/rivet/commit/3cbfc1b593bcfebf4f3acee261926ac6ab613531))
* fix telemetry queries ([#1277](https://github.com/Mu-L/rivet/issues/1277)) ([a2d5120](https://github.com/Mu-L/rivet/commit/a2d51205a5c3c54fb0d3efc5ffb6713ac5cb6f7e))
* fix ts types for actor bindings ([#1470](https://github.com/Mu-L/rivet/issues/1470)) ([6ca6764](https://github.com/Mu-L/rivet/commit/6ca6764f638e068de32be4e86cca9e6ea23fd6db))
* fix tunnels ([#1227](https://github.com/Mu-L/rivet/issues/1227)) ([30fda93](https://github.com/Mu-L/rivet/commit/30fda93bac067e78bfce9832bbaf3a712d8e898d))
* fix type definitions for rpcs ([#1535](https://github.com/Mu-L/rivet/issues/1535)) ([c95ecc3](https://github.com/Mu-L/rivet/commit/c95ecc3a6dadae3ca8b5f0c9941f541753a9a029))
* fix url version conflicts with deno ([#1234](https://github.com/Mu-L/rivet/issues/1234)) ([002024d](https://github.com/Mu-L/rivet/commit/002024dedabb6db33e91521e2b82e908e686a646))
* fix various bugs ([#1356](https://github.com/Mu-L/rivet/issues/1356)) ([61efc1a](https://github.com/Mu-L/rivet/commit/61efc1aa9d8a5148344ba9065a48215d7bc2c902))
* fmt and downgrade tokio ([#1222](https://github.com/Mu-L/rivet/issues/1222)) ([2f9ae5b](https://github.com/Mu-L/rivet/commit/2f9ae5bc0fe756025e9c3de859ad4d7ef0e30da3))
* get pegboard -&gt; fdb connection over vlan ([#1362](https://github.com/Mu-L/rivet/issues/1362)) ([12f01f7](https://github.com/Mu-L/rivet/commit/12f01f700b0c18742e5c4eab0931443eadd6eda6))
* get pegboard working e2e ([#1253](https://github.com/Mu-L/rivet/issues/1253)) ([858a88b](https://github.com/Mu-L/rivet/commit/858a88b0c625c44751d5953e60a67ef1ab827f88))
* **group:** require &gt; 1 use count on invites ([#985](https://github.com/Mu-L/rivet/issues/985)) ([b37565a](https://github.com/Mu-L/rivet/commit/b37565afc2283c77134a31c7619f0778d80e273f))
* implement host networking for ds ([#1273](https://github.com/Mu-L/rivet/issues/1273)) ([2c1a05a](https://github.com/Mu-L/rivet/commit/2c1a05ad938eb165c90480e9bec051021da6930f))
* improve isolate error handling ([#1451](https://github.com/Mu-L/rivet/issues/1451)) ([47d01df](https://github.com/Mu-L/rivet/commit/47d01df3f0714c040afb9f0c1b1621d0e9e37acf))
* incorrect use of `Metrics` in `rivet.health` config ([#1269](https://github.com/Mu-L/rivet/issues/1269)) ([aa29bd4](https://github.com/Mu-L/rivet/commit/aa29bd4bee89cfe9655d3a1c917f2b8f8c58d85b))
* **infra:** dynamically generate nomad server count in install script ([#981](https://github.com/Mu-L/rivet/issues/981)) ([9c433d8](https://github.com/Mu-L/rivet/commit/9c433d8e9dbc4e032c22c25dc4790301a887592e))
* **infra:** force linux/amd64 platform for building job-runner artifact ([#937](https://github.com/Mu-L/rivet/issues/937)) ([1a32f90](https://github.com/Mu-L/rivet/commit/1a32f90f2c60883e4a9f4a04d5d8a7ff6b445f93))
* **infra:** pass dynamic tunnel host port to cluster-server-install ([#980](https://github.com/Mu-L/rivet/issues/980)) ([8be472f](https://github.com/Mu-L/rivet/commit/8be472f2bce95fa8149f454ff92b98033fb44623))
* **infra:** re-run sshd config if dev tunnel machine recreated ([#978](https://github.com/Mu-L/rivet/issues/978)) ([7fa5cff](https://github.com/Mu-L/rivet/commit/7fa5cff9bb697090c6fab13228afe32f661f91c2))
* **infra:** remove dep on unused api_route secret ([#935](https://github.com/Mu-L/rivet/issues/935)) ([7fca24b](https://github.com/Mu-L/rivet/commit/7fca24b22b6e12ef8f361c5e25f29ae85cc629bc))
* **infra:** remove k8s_infra -&gt; cockroach_k8s circular dependency ([#936](https://github.com/Mu-L/rivet/issues/936)) ([41b6cdb](https://github.com/Mu-L/rivet/commit/41b6cdb7c82ce78245a322b0d44b0ef722be9f01))
* **infra:** resolve correct cockroachdb remote state ([#976](https://github.com/Mu-L/rivet/issues/976)) ([8413349](https://github.com/Mu-L/rivet/commit/8413349876f7e70d19b0b4a5497d571cf7bcef74))
* **ip:** cache ip queries ([#907](https://github.com/Mu-L/rivet/issues/907)) ([c36d150](https://github.com/Mu-L/rivet/commit/c36d15081096abea64679070aac50791d6c5ded7))
* **job-run:** delete second allocation immediately ([#1104](https://github.com/Mu-L/rivet/issues/1104)) ([78b73fd](https://github.com/Mu-L/rivet/commit/78b73fd30b56f192fd23d07f7b57475a88a2f5e2))
* **job-run:** fix dupe allocs, re-enable drain all ([#1128](https://github.com/Mu-L/rivet/issues/1128)) ([d019e01](https://github.com/Mu-L/rivet/commit/d019e01cfc9f6420492f9e9213563b4823ff23fe))
* js bundle unarchiving ([#1456](https://github.com/Mu-L/rivet/issues/1456)) ([9a89891](https://github.com/Mu-L/rivet/commit/9a898917759a55242c9674ed2ffe3d7f1b722634))
* **k3d:** mount host volume for PVCs ([#1018](https://github.com/Mu-L/rivet/issues/1018)) ([07fae51](https://github.com/Mu-L/rivet/commit/07fae51d196e6ea69bb5149c41fc84d6fcc9f3b0))
* listen for destroy on actor create endpoint ([#1466](https://github.com/Mu-L/rivet/issues/1466)) ([bcc5852](https://github.com/Mu-L/rivet/commit/bcc5852aca2f105bdabb46aef1072d14889b921e))
* loops and cache ([#1010](https://github.com/Mu-L/rivet/issues/1010)) ([bccce31](https://github.com/Mu-L/rivet/commit/bccce312dbb75bd8e49d40260e47a8d7d8b98bae))
* lower upload limit for js builds ([#1472](https://github.com/Mu-L/rivet/issues/1472)) ([2ffc65b](https://github.com/Mu-L/rivet/commit/2ffc65b9a97018f55c6b618dac86cf1400e4bd40))
* make isolate runtime local ([#1517](https://github.com/Mu-L/rivet/issues/1517)) ([8a8b8a2](https://github.com/Mu-L/rivet/commit/8a8b8a24b9649bf38878df9a3163bae53f7a0d3d))
* make kv metadata version to bytes ([#1435](https://github.com/Mu-L/rivet/issues/1435)) ([44d9f7c](https://github.com/Mu-L/rivet/commit/44d9f7c8de4bdaddaea6a233400c93df12c271e4))
* **mm, ds:** fix dupe alloc killing ([#1124](https://github.com/Mu-L/rivet/issues/1124)) ([dcdb06a](https://github.com/Mu-L/rivet/commit/dcdb06a050b12561a679a84f4b243417a15d3071))
* **mm:** add index for run_proxied_ports ([#868](https://github.com/Mu-L/rivet/issues/868)) ([e0785e9](https://github.com/Mu-L/rivet/commit/e0785e9635f5051863b9e9fcb240dfe446d52729))
* **mm:** call mm-lobby-cleanup from mm-gc even for preemptive lobbies without sql row ([#856](https://github.com/Mu-L/rivet/issues/856)) ([5315a9a](https://github.com/Mu-L/rivet/commit/5315a9a4e675ed24e7d2926b1ce07b6ecd213e61))
* **mm:** clean up players from gc zset ([#914](https://github.com/Mu-L/rivet/issues/914)) ([d6d05f6](https://github.com/Mu-L/rivet/commit/d6d05f634d7fa2c57be97e41e808ad8742440982))
* **mm:** correctly handle lobby not found error if joining direclty to lobby id that doesn't exist ([#867](https://github.com/Mu-L/rivet/issues/867)) ([af3513a](https://github.com/Mu-L/rivet/commit/af3513a5947a99f83bbcb9866117dc3578ff0efb))
* **mm:** move runtime aggregate logic into query ([#966](https://github.com/Mu-L/rivet/issues/966)) ([e545271](https://github.com/Mu-L/rivet/commit/e545271d0c3a3fb00f19924c8c2618e4cc0c911c))
* **mm:** require specifying matchmaker config for new game versions ([#895](https://github.com/Mu-L/rivet/issues/895)) ([92d86fd](https://github.com/Mu-L/rivet/commit/92d86fd8f71cfe54ba1c1e28215060e256c0105f))
* **mm:** skip prewarming ats if no nodes booted ([#970](https://github.com/Mu-L/rivet/issues/970)) ([61e9f14](https://github.com/Mu-L/rivet/commit/61e9f14c046ff5fe395435e7919bb76e89ccef52))
* more accurate job-run cpu metrics ([#1122](https://github.com/Mu-L/rivet/issues/1122)) ([312958e](https://github.com/Mu-L/rivet/commit/312958e79b97f5b57eb297fcc03d2e1a3d2cd695))
* move cluster config to rivet config ([#1295](https://github.com/Mu-L/rivet/issues/1295)) ([472c54f](https://github.com/Mu-L/rivet/commit/472c54f79a9ba826a46a16bcc5f29b39b7d2a84f))
* move default builds to tf, bump s3 sdk ([#1237](https://github.com/Mu-L/rivet/issues/1237)) ([0194031](https://github.com/Mu-L/rivet/commit/01940317cc79d4aa2b566002eaf47a87595f03ca))
* move hosts file into oci bundle ([#1433](https://github.com/Mu-L/rivet/issues/1433)) ([8c45cbd](https://github.com/Mu-L/rivet/commit/8c45cbd2edccafe45183689108f9e2b1504257e1))
* nomad url templating ([#1257](https://github.com/Mu-L/rivet/issues/1257)) ([80201f8](https://github.com/Mu-L/rivet/commit/80201f81f3eb019fd8fef8060bc54b04ce98e37a))
* **nomad:** readd allocation metrics ([#1109](https://github.com/Mu-L/rivet/issues/1109)) ([600d4fb](https://github.com/Mu-L/rivet/commit/600d4fb6df38bfd123045bf7cd35182b2b37342f))
* **opengb:** opengb. -&gt; backend. ([#919](https://github.com/Mu-L/rivet/issues/919)) ([dfe5f8b](https://github.com/Mu-L/rivet/commit/dfe5f8b17f017c43666d38edece48b886dfc8c28))
* **pegboard:** add dc id to pb client ([#1163](https://github.com/Mu-L/rivet/issues/1163)) ([6be42ba](https://github.com/Mu-L/rivet/commit/6be42baba4c8826a020810ba625cd75c3b0684c7))
* **pegboard:** fix migrations ([#1230](https://github.com/Mu-L/rivet/issues/1230)) ([3f10f74](https://github.com/Mu-L/rivet/commit/3f10f74f04c29ca6792971bb4d06e7fee0a21cfd))
* **pegboard:** get pb running on edge ([#1154](https://github.com/Mu-L/rivet/issues/1154)) ([f0c1a18](https://github.com/Mu-L/rivet/commit/f0c1a189432a699ec08e0bb8c503dd9e6bdd64d1))
* **pegboard:** implement cleanup, rebuild, fix queries ([#1150](https://github.com/Mu-L/rivet/issues/1150)) ([2bc957b](https://github.com/Mu-L/rivet/commit/2bc957b84dbc66cb144e7275ebf81080155ee5bb))
* **pegboard:** implement port choosing ([#1155](https://github.com/Mu-L/rivet/issues/1155)) ([b0825e1](https://github.com/Mu-L/rivet/commit/b0825e1655dfd1e5591ddf5d0f3d6d467c360687))
* rebuild isolate runner handle before starting runner socket ([#1376](https://github.com/Mu-L/rivet/issues/1376)) ([cdda797](https://github.com/Mu-L/rivet/commit/cdda797bd7401f0a6832185ff6d3793ac6893013))
* reduce scheduler skew on distributed clusters ([#1175](https://github.com/Mu-L/rivet/issues/1175)) ([2794e09](https://github.com/Mu-L/rivet/commit/2794e0986fe14147ee92f8381cab7c517a0f28fb))
* remove actor args from api ([#1450](https://github.com/Mu-L/rivet/issues/1450)) ([f4e2f42](https://github.com/Mu-L/rivet/commit/f4e2f426123a3f2c4815c9285fc4a977f893d92d))
* remove cgroups from pb manager ([#1385](https://github.com/Mu-L/rivet/issues/1385)) ([57d6d66](https://github.com/Mu-L/rivet/commit/57d6d66040d42f59debaf3c78cefe9d67d4efd4b))
* remove chirp-workflow as a downstream dependency for pegboard-manager ([#1293](https://github.com/Mu-L/rivet/issues/1293)) ([8ede99b](https://github.com/Mu-L/rivet/commit/8ede99b8444ad47e7d559170724d3b4c8ea14c4a))
* remove multipart flag ([#1431](https://github.com/Mu-L/rivet/issues/1431)) ([d927f15](https://github.com/Mu-L/rivet/commit/d927f1500265b6f6422525a69db5e9cabed27011))
* remove non-deterministic fern check ([#1415](https://github.com/Mu-L/rivet/issues/1415)) ([2fbecba](https://github.com/Mu-L/rivet/commit/2fbecba45bf15e50edbb8959f27ddb2f921b2f0c))
* remove trailing slash from endpoint ([#1012](https://github.com/Mu-L/rivet/issues/1012)) ([b3bd44f](https://github.com/Mu-L/rivet/commit/b3bd44fc461e07d60276ac9fe2ec6c0a01b5a105))
* rename ports vars to uppercase ([#1485](https://github.com/Mu-L/rivet/issues/1485)) ([d59dd0e](https://github.com/Mu-L/rivet/commit/d59dd0e554dbf92bb740a7356000388f2f738372))
* resolve actor create build tags to the env instead of game ([#1430](https://github.com/Mu-L/rivet/issues/1430)) ([ad50f4a](https://github.com/Mu-L/rivet/commit/ad50f4af2c8cacef58b4f778bc908cfc4445ae98))
* restructure pegboard install ([#1221](https://github.com/Mu-L/rivet/issues/1221)) ([a26418e](https://github.com/Mu-L/rivet/commit/a26418e4141e9949d53d4243b8c852dfc8bd2f80))
* return early if actor already destroyed ([#1497](https://github.com/Mu-L/rivet/issues/1497)) ([4ac0a4c](https://github.com/Mu-L/rivet/commit/4ac0a4cf442fc1f0cfe42a999c76a216413e2332))
* revert hotfix ([#934](https://github.com/Mu-L/rivet/issues/934)) ([115f02e](https://github.com/Mu-L/rivet/commit/115f02e43db2c16b474dcc5dbee76f8d69ab1465))
* rework failing for ds wf ([#1449](https://github.com/Mu-L/rivet/issues/1449)) ([4614742](https://github.com/Mu-L/rivet/commit/4614742a0f954f9b753304cae1d67d4ce589d2a9))
* run vector in container ([#1302](https://github.com/Mu-L/rivet/issues/1302)) ([aba8fb4](https://github.com/Mu-L/rivet/commit/aba8fb401d147f66ebde67e008b2d8c64226ffc7))
* servers cors ([#1013](https://github.com/Mu-L/rivet/issues/1013)) ([e46edfb](https://github.com/Mu-L/rivet/commit/e46edfba82bff93b34adc2870f94635cbe26149e))
* **servers:** fix broken insert ([#1033](https://github.com/Mu-L/rivet/issues/1033)) ([6e79bc7](https://github.com/Mu-L/rivet/commit/6e79bc742a54d9451162a28ebb2677d882eb4cd8))
* **servers:** remove migrate block ([#1027](https://github.com/Mu-L/rivet/issues/1027)) ([eab8ec4](https://github.com/Mu-L/rivet/commit/eab8ec4032317b0b4e6a03dd45c0b7d1e84a95f1))
* **servers:** use correct timeout for sleeping ([#1076](https://github.com/Mu-L/rivet/issues/1076)) ([0c58f83](https://github.com/Mu-L/rivet/commit/0c58f835529da2cb0f8883425a6cbe824d12d759))
* **ssh:** force user for ssh commands ([#949](https://github.com/Mu-L/rivet/issues/949)) ([ba02a16](https://github.com/Mu-L/rivet/commit/ba02a166e7623a797fb329da63a858d82f8e8636))
* standardize presigned requests output for actor builds, build tags on create ([#1397](https://github.com/Mu-L/rivet/issues/1397)) ([cb012d7](https://github.com/Mu-L/rivet/commit/cb012d7fbc85fdde58e6ceceffa5a9159c2b4b1f))
* **tls:** provision cloudflare cert pack if opengb enabled ([#869](https://github.com/Mu-L/rivet/issues/869)) ([1dafa9e](https://github.com/Mu-L/rivet/commit/1dafa9ea943466fbcd6a5a5ed601877f9e94697b))
* update api endpoint names ([#1080](https://github.com/Mu-L/rivet/issues/1080)) ([33e780d](https://github.com/Mu-L/rivet/commit/33e780dacad902e0041cad7c0881d0bf308b61fe))
* update cloudflare crate ([#1009](https://github.com/Mu-L/rivet/issues/1009)) ([4e478f1](https://github.com/Mu-L/rivet/commit/4e478f13f65e95cee7bf1b776a196263a962dc7c))
* update cluster paths for rivet-client ([#1315](https://github.com/Mu-L/rivet/issues/1315)) ([f2ec038](https://github.com/Mu-L/rivet/commit/f2ec03869a632b916162514ed50d9dfc98f9e438))
* update default hub origin to have /ui/ path ([#1464](https://github.com/Mu-L/rivet/issues/1464)) ([0e53a0e](https://github.com/Mu-L/rivet/commit/0e53a0eada9fe427bdc37ebaa1cb8541720b74e0))
* update ds state when failed to allocate ([#1375](https://github.com/Mu-L/rivet/issues/1375)) ([2acaf82](https://github.com/Mu-L/rivet/commit/2acaf8223692e080178b73ccae76ac455f36d048))
* update gitignores to include externals ([#1394](https://github.com/Mu-L/rivet/issues/1394)) ([f61b800](https://github.com/Mu-L/rivet/commit/f61b800c99714999eacdbc9dbb0242bd6b8cd8dd))
* update runtime audiences ([#1393](https://github.com/Mu-L/rivet/issues/1393)) ([9457bee](https://github.com/Mu-L/rivet/commit/9457beeb638b3e7be63fdf5dcf56378656fccd69))
* use correct endpoint for upload-prepare preisgned requests & presigning docs ([#1396](https://github.com/Mu-L/rivet/issues/1396)) ([c4f2062](https://github.com/Mu-L/rivet/commit/c4f2062776ee82c6b924b99439df30f9a9ffc47c))
* use EndpointKind::EdgeInternal for BuildDeliveryMethod::S3Direct ([#1429](https://github.com/Mu-L/rivet/issues/1429)) ([b2ad415](https://github.com/Mu-L/rivet/commit/b2ad415899d15bfd19433125b514413502064053))
* use internal endpoint for s3 provision ([#1318](https://github.com/Mu-L/rivet/issues/1318)) ([357589c](https://github.com/Mu-L/rivet/commit/357589cac04452345f260188072f889399dcdde8))
* validate build belongs to game ([#1523](https://github.com/Mu-L/rivet/issues/1523)) ([14f3312](https://github.com/Mu-L/rivet/commit/14f3312d00e8eae2f71f702529701cffc6e62e3a))
* validate tags arent empty ([#1528](https://github.com/Mu-L/rivet/issues/1528)) ([4a1d9ad](https://github.com/Mu-L/rivet/commit/4a1d9ad73541b0c6242f6b41cdcbb31028749643))
* **worfklows:** add silence ts ([#1129](https://github.com/Mu-L/rivet/issues/1129)) ([06d965b](https://github.com/Mu-L/rivet/commit/06d965bf9088b1a69177f9e7fac7d3b7d9e8371d))
* workflow ts hotfix ([#933](https://github.com/Mu-L/rivet/issues/933)) ([20796db](https://github.com/Mu-L/rivet/commit/20796db7811683b6c3a16caaaa40fac865259b4c))
* **workflow:** fix sleep logic ([#1084](https://github.com/Mu-L/rivet/issues/1084)) ([3202fdf](https://github.com/Mu-L/rivet/commit/3202fdf64b24f1a62517d39659660222115beb8e))
* **workflows:** add back location bump to catch unrec ([#1087](https://github.com/Mu-L/rivet/issues/1087)) ([4816533](https://github.com/Mu-L/rivet/commit/48165331a3465371f74b84ba3fd9f021fc0a4538))
* **workflows:** add error message for max sql retries ([#1125](https://github.com/Mu-L/rivet/issues/1125)) ([80a33f0](https://github.com/Mu-L/rivet/commit/80a33f00509b7c08aa3a670ded38f180fc9d29f7))
* **workflows:** add idx ([#1038](https://github.com/Mu-L/rivet/issues/1038)) ([d825483](https://github.com/Mu-L/rivet/commit/d825483be4dabb1f9641261cb994087c9e6f5bf3))
* **workflows:** add limit to pulling workflows ([#1020](https://github.com/Mu-L/rivet/issues/1020)) ([6766ea0](https://github.com/Mu-L/rivet/commit/6766ea08f66824f73a51782c21c133998ece07e1))
* **workflows:** add retry delay for txn errors ([#1138](https://github.com/Mu-L/rivet/issues/1138)) ([614846b](https://github.com/Mu-L/rivet/commit/614846be4f712e570bfcf5e3cf595848ce60852d))
* **workflows:** add retry to internal sql queries ([#1112](https://github.com/Mu-L/rivet/issues/1112)) ([ef010d0](https://github.com/Mu-L/rivet/commit/ef010d089652693985efbda45e59421dff698d78))
* **workflows:** add sql retries, improve history diverged errors ([#995](https://github.com/Mu-L/rivet/issues/995)) ([9b0724f](https://github.com/Mu-L/rivet/commit/9b0724f26d8b614fdea836b65849d9334cb9ed5e))
* **workflows:** add ts dt ([#943](https://github.com/Mu-L/rivet/issues/943)) ([1b362fd](https://github.com/Mu-L/rivet/commit/1b362fd83141328d4da0b3528a9691bdd14c5878))
* **workflows:** dont delete signal rows ([#965](https://github.com/Mu-L/rivet/issues/965)) ([be67080](https://github.com/Mu-L/rivet/commit/be670808bf2c130d1e077051a15d620dd12462cd))
* **workflows:** filter messages by tags ([#1142](https://github.com/Mu-L/rivet/issues/1142)) ([f07c270](https://github.com/Mu-L/rivet/commit/f07c270caf61a89076e8db93444071c44dc151b1))
* **workflows:** fix backfill ([#1025](https://github.com/Mu-L/rivet/issues/1025)) ([6f7c94c](https://github.com/Mu-L/rivet/commit/6f7c94c6bf63f48b2674787a5f1e869197043a13))
* **workflows:** fix docs on macros ([#1075](https://github.com/Mu-L/rivet/issues/1075)) ([1175ae5](https://github.com/Mu-L/rivet/commit/1175ae5f1dfd924f033c7c26c7bdc0e1896b628b))
* **workflows:** fix gc, event history graph, internal naming ([#963](https://github.com/Mu-L/rivet/issues/963)) ([8b97b32](https://github.com/Mu-L/rivet/commit/8b97b325a0c188b32033f73fde4ee67c67405e3c))
* **workflows:** fix invalid error wrapping ([#1092](https://github.com/Mu-L/rivet/issues/1092)) ([7014d1b](https://github.com/Mu-L/rivet/commit/7014d1bc24c93e52eef24519a42d4a1bb105ac0d))
* **workflows:** fix invalid event history graph ([#996](https://github.com/Mu-L/rivet/issues/996)) ([fe2c38e](https://github.com/Mu-L/rivet/commit/fe2c38ec19133b6613c404076039aaca74280634))
* **workflows:** fix listening traits ([#988](https://github.com/Mu-L/rivet/issues/988)) ([0e56121](https://github.com/Mu-L/rivet/commit/0e56121145d89d1856bc0528de9e507e2687cec9))
* **workflows:** fix loops queries ([#1042](https://github.com/Mu-L/rivet/issues/1042)) ([63a7601](https://github.com/Mu-L/rivet/commit/63a76013a4c6958be14cc16d0b0500e9a5908ea7))
* **workflows:** get workflows working again with new history management ([#1210](https://github.com/Mu-L/rivet/issues/1210)) ([f718812](https://github.com/Mu-L/rivet/commit/f71881288a6f45f9077817b69daec25a3e6bd450))
* **workflows:** implement backoff for timeouts ([#1111](https://github.com/Mu-L/rivet/issues/1111)) ([6659b34](https://github.com/Mu-L/rivet/commit/6659b34f41e9e0e1f31b21ffd45485cfba4d6e09))
* **workflows:** increase metrics publish interval ([#1050](https://github.com/Mu-L/rivet/issues/1050)) ([b46300c](https://github.com/Mu-L/rivet/commit/b46300caaa41e96da54d1d79df18cd6a68405f27))
* **workflows:** rename signals, improve failure handling for server install ([#1043](https://github.com/Mu-L/rivet/issues/1043)) ([40cb84a](https://github.com/Mu-L/rivet/commit/40cb84a9288bddb65f72f5fca86bb1391bfee9cd))
* **workflows:** Throw errors for duplicate workflows ([#1011](https://github.com/Mu-L/rivet/issues/1011)) ([53c3aeb](https://github.com/Mu-L/rivet/commit/53c3aebbec4ecbc58a24f45579f7c1220d7b2da1))
* **workflows:** use unions instead of OR ([#1170](https://github.com/Mu-L/rivet/issues/1170)) ([1ca8ab6](https://github.com/Mu-L/rivet/commit/1ca8ab64e3793eb1b53839b7139b73c1b800377f))


### Documentation

* reorg docs ([#1259](https://github.com/Mu-L/rivet/issues/1259)) ([34602e1](https://github.com/Mu-L/rivet/commit/34602e1ad2b7da5529c6ebcd0f14dc0b27edf768))


### Chores

* add `rivet manager endpoint` ([#1539](https://github.com/Mu-L/rivet/issues/1539)) ([d1a8188](https://github.com/Mu-L/rivet/commit/d1a8188a620aae92860576618e46b8adb686f130))
* add actor upgrades to deploys ([#1543](https://github.com/Mu-L/rivet/issues/1543)) ([f70947c](https://github.com/Mu-L/rivet/commit/f70947c1ee14a220ee664aa7ed6e3c3922448f7e))
* add actor-types sdk & move js ext to typescript ([#1458](https://github.com/Mu-L/rivet/issues/1458)) ([e800f20](https://github.com/Mu-L/rivet/commit/e800f20156113f0fc1242bd34862696eeb29e818))
* add back node exporter metrics ([#1136](https://github.com/Mu-L/rivet/issues/1136)) ([1eeedcb](https://github.com/Mu-L/rivet/commit/1eeedcb83be74398c8ac71888bd652305c154666))
* add build get endpoint ([#1046](https://github.com/Mu-L/rivet/issues/1046)) ([e4f03fb](https://github.com/Mu-L/rivet/commit/e4f03fbbcd52db1dafcd625649b2bceee7d7103d))
* add client config to pb clients ([#1329](https://github.com/Mu-L/rivet/issues/1329)) ([ff2c7e4](https://github.com/Mu-L/rivet/commit/ff2c7e4efa7d81219dfdb6a5a7d951320b4702ed))
* add client container to docker compose ([#1289](https://github.com/Mu-L/rivet/issues/1289)) ([15c844c](https://github.com/Mu-L/rivet/commit/15c844c4712352660c3d3734169546610a28e1d5))
* add default user/team/project/env ([#1310](https://github.com/Mu-L/rivet/issues/1310)) ([1dc72f2](https://github.com/Mu-L/rivet/commit/1dc72f2b67846857b585e7bfd2602f972f5abd63))
* add deno passthrough ([#1541](https://github.com/Mu-L/rivet/issues/1541)) ([10fe8d7](https://github.com/Mu-L/rivet/commit/10fe8d7f47b2de347665af1782e1d99434296221))
* add docker-compose.yaml ([#1254](https://github.com/Mu-L/rivet/issues/1254)) ([58d53e1](https://github.com/Mu-L/rivet/commit/58d53e1243514a4e983db46c992dda9f5d9c5b99))
* add docs on handling of jwt ([#1353](https://github.com/Mu-L/rivet/issues/1353)) ([571e9f6](https://github.com/Mu-L/rivet/commit/571e9f62012694fbb63cba452cd27d580fa33d1e))
* add foundationdb to dev-full & document avx support ([#1426](https://github.com/Mu-L/rivet/issues/1426)) ([f6708f3](https://github.com/Mu-L/rivet/commit/f6708f397a55a404e358aefbedf2ab04f3432e5b))
* add framer to index page ([#1390](https://github.com/Mu-L/rivet/issues/1390)) ([25c62b3](https://github.com/Mu-L/rivet/commit/25c62b312f4ec93a3ccbe29552b61205a424bddd))
* add game id to server endpoints ([#1014](https://github.com/Mu-L/rivet/issues/1014)) ([31f586f](https://github.com/Mu-L/rivet/commit/31f586f5df2240c8cb688fd56013b8f0473afb54))
* add health checks to docker ([#1262](https://github.com/Mu-L/rivet/issues/1262)) ([3b4b1f0](https://github.com/Mu-L/rivet/commit/3b4b1f096bbfd5ed230135a665496d794d838026))
* add historical server query ([#1056](https://github.com/Mu-L/rivet/issues/1056)) ([c3d7c96](https://github.com/Mu-L/rivet/commit/c3d7c966724034ae89ad0ac4c233f5a36dc64d80))
* add implicit rpc calls to actors ([#1516](https://github.com/Mu-L/rivet/issues/1516)) ([c92a40b](https://github.com/Mu-L/rivet/commit/c92a40ba45947caca6e58c7cd4bbb85f7f47dd75))
* add lines to provisioning metrics ([#912](https://github.com/Mu-L/rivet/issues/912)) ([d0371e0](https://github.com/Mu-L/rivet/commit/d0371e00d9f05eecc7b6ec03e95061fa8c3dea49))
* add logging filters, reduce excess logging ([#1287](https://github.com/Mu-L/rivet/issues/1287)) ([6e56610](https://github.com/Mu-L/rivet/commit/6e56610f17d79c791be7a9c7c474b563bfd35b67))
* add manual e2e test for js actors ([#1322](https://github.com/Mu-L/rivet/issues/1322)) ([6885adb](https://github.com/Mu-L/rivet/commit/6885adbf60167359abf4b2c45290d76cac7485b4))
* add monolith container ([#1363](https://github.com/Mu-L/rivet/issues/1363)) ([1d5e805](https://github.com/Mu-L/rivet/commit/1d5e805d76f593b2fc1c03d0ab3ed25b9b35a10c))
* add monolith entry crate ([#1208](https://github.com/Mu-L/rivet/issues/1208)) ([c2a4c86](https://github.com/Mu-L/rivet/commit/c2a4c8635df696459015ac22c36b48d5cae57050))
* add os info to telemetry beacon ([#1235](https://github.com/Mu-L/rivet/issues/1235)) ([d00491f](https://github.com/Mu-L/rivet/commit/d00491f5bacf6d09b68a4dc775ea2a4764f79e59))
* add pb runner troubleshooting ([#1432](https://github.com/Mu-L/rivet/issues/1432)) ([a9db3de](https://github.com/Mu-L/rivet/commit/a9db3de11cb7a3628baa7c3eb3f1aa78cca2040c))
* add prepareConnection, fix protected actor methods ([#1533](https://github.com/Mu-L/rivet/issues/1533)) ([d73d026](https://github.com/Mu-L/rivet/commit/d73d026f36797a7f46251d791c4de700122c53ce))
* add region id & name to rivet meta ([#1511](https://github.com/Mu-L/rivet/issues/1511)) ([9765a83](https://github.com/Mu-L/rivet/commit/9765a83f2bd2f25935060f251c1193a6ae27d155))
* add servers backwards compatability ([#1335](https://github.com/Mu-L/rivet/issues/1335)) ([a470cec](https://github.com/Mu-L/rivet/commit/a470cec246dd8aafb27c1816a90271bf3987c562))
* add shell container & add back db commands ([#1215](https://github.com/Mu-L/rivet/issues/1215)) ([d7df31d](https://github.com/Mu-L/rivet/commit/d7df31dde76fdb4145c19b1899a65c69476523ba))
* add sqlx max connection timeout jitter ([#916](https://github.com/Mu-L/rivet/issues/916)) ([4513a1f](https://github.com/Mu-L/rivet/commit/4513a1fcadedcf7f4f3ca2609558f24a11c438d4))
* add support for running pb client without cgroups ([#1371](https://github.com/Mu-L/rivet/issues/1371)) ([ffb294d](https://github.com/Mu-L/rivet/commit/ffb294df3abf6fc8ef6ae502088e0ae520efc2bd))
* add welcome message to monolith ([#1405](https://github.com/Mu-L/rivet/issues/1405)) ([d73fa4d](https://github.com/Mu-L/rivet/commit/d73fa4da43efdb94e9b7dd4bb67eaadf6ed5f808))
* allow configuring isolate runner port ([#1366](https://github.com/Mu-L/rivet/issues/1366)) ([746a2f1](https://github.com/Mu-L/rivet/commit/746a2f1687f71b86a5ad7afdce3698427b89bd75))
* archive old linode servers table ([#1052](https://github.com/Mu-L/rivet/issues/1052)) ([f6126f6](https://github.com/Mu-L/rivet/commit/f6126f6762b799b7114ad72d928c3052230e38f5))
* authenticate default development user ([#1312](https://github.com/Mu-L/rivet/issues/1312)) ([82d653d](https://github.com/Mu-L/rivet/commit/82d653d7435cf0706c4a6d9b1f8da1953f8096cb))
* auto-publish docker images ([#1373](https://github.com/Mu-L/rivet/issues/1373)) ([f3c07c3](https://github.com/Mu-L/rivet/commit/f3c07c30fca491b912c215f7ae3d56be9bcaabb4))
* auto-read manager endpoint in tests ([#1542](https://github.com/Mu-L/rivet/issues/1542)) ([f8f29b9](https://github.com/Mu-L/rivet/commit/f8f29b9e7e9002bf74df7b47e8065d03fbb72aa1))
* automatically print admin access token url ([#1285](https://github.com/Mu-L/rivet/issues/1285)) ([c4dddc2](https://github.com/Mu-L/rivet/commit/c4dddc20562e2d0a8ddf66cdf87b4b905ebd8d5e))
* **bolt:** add color to cargo build with docker ([#1035](https://github.com/Mu-L/rivet/issues/1035)) ([7c324e5](https://github.com/Mu-L/rivet/commit/7c324e5cfcfef929bc08537e1b13f226f0c4f4b8))
* **bolt:** make cluster optional ([#1164](https://github.com/Mu-L/rivet/issues/1164)) ([b625213](https://github.com/Mu-L/rivet/commit/b6252134e0a98c08b9addf064aa03ea6d1629d2c))
* **bolt:** update lockfile ([#1029](https://github.com/Mu-L/rivet/issues/1029)) ([2140c0a](https://github.com/Mu-L/rivet/commit/2140c0ac59f1b27366792e5a88315e23580ee6c1))
* **bolt:** upgrade rust to 1.80.0 ([#1028](https://github.com/Mu-L/rivet/issues/1028)) ([44f6aa7](https://github.com/Mu-L/rivet/commit/44f6aa76206faecfab59f1b71c6c350476babce0))
* **build:** add patching build tags ([#1048](https://github.com/Mu-L/rivet/issues/1048)) ([812b7e2](https://github.com/Mu-L/rivet/commit/812b7e231ddfc5f5d69af2756ea4ad10ffe1bef6))
* bump hub ui ([#1347](https://github.com/Mu-L/rivet/issues/1347)) ([b94f2fc](https://github.com/Mu-L/rivet/commit/b94f2fcde9450eb3684041135b35b8fcc75b97dc))
* cache mm-config-version-get ([#913](https://github.com/Mu-L/rivet/issues/913)) ([3b24383](https://github.com/Mu-L/rivet/commit/3b2438338307e91d39117d7ea13592036163ff9d))
* clean up client config & e2e working manual test ([#1333](https://github.com/Mu-L/rivet/issues/1333)) ([84c5d03](https://github.com/Mu-L/rivet/commit/84c5d037557410842585e3f19ae9747440ce0f87))
* clean up fern naming ([#1045](https://github.com/Mu-L/rivet/issues/1045)) ([f4c13a8](https://github.com/Mu-L/rivet/commit/f4c13a81725883181576570de708ba3a2600a86e))
* clean up openapi gen script ([#1504](https://github.com/Mu-L/rivet/issues/1504)) ([d71c685](https://github.com/Mu-L/rivet/commit/d71c68519fe52f55f7adf85ad5ac258460d9cb77))
* cleanup runtime aggregate op ([#902](https://github.com/Mu-L/rivet/issues/902)) ([538d9b8](https://github.com/Mu-L/rivet/commit/538d9b811ecb76ad95d201754745ed0c82224063))
* **cloud:** update default version format to not use special characters ([#1003](https://github.com/Mu-L/rivet/issues/1003)) ([accb1d8](https://github.com/Mu-L/rivet/commit/accb1d825fb433cde816338a954426da55015988))
* **cluster:** cache datacenter-get and datacenter-location-get ([#908](https://github.com/Mu-L/rivet/issues/908)) ([8863a8b](https://github.com/Mu-L/rivet/commit/8863a8b075e0cd31ed6a349e655559efd4da4427))
* **clusters:** remove git as a dependency for cluster util ([#931](https://github.com/Mu-L/rivet/issues/931)) ([7c7eec3](https://github.com/Mu-L/rivet/commit/7c7eec38fb617887d57e35458df32fe36e1ca55a))
* configure cluster for faster migrations in dev ([#1368](https://github.com/Mu-L/rivet/issues/1368)) ([4dd3324](https://github.com/Mu-L/rivet/commit/4dd3324ec730facff1109094bc57106e5958f81d))
* convert health checks & metrics to services ([#1267](https://github.com/Mu-L/rivet/issues/1267)) ([45f0247](https://github.com/Mu-L/rivet/commit/45f024750693c9fac1f236b34ab4bdbc6178f3da))
* convert more actor params to optional ([#1389](https://github.com/Mu-L/rivet/issues/1389)) ([c96d528](https://github.com/Mu-L/rivet/commit/c96d528d1509d31455602c109cd102ad4345c7d4))
* disable release build on monolith ([#1407](https://github.com/Mu-L/rivet/issues/1407)) ([bfd14c9](https://github.com/Mu-L/rivet/commit/bfd14c92fcf84a2b9137ca42da1d5362cb1633db))
* disable use_mounts in docker clients ([#1491](https://github.com/Mu-L/rivet/issues/1491)) ([e2cea9a](https://github.com/Mu-L/rivet/commit/e2cea9a88ae0ec93424a900210c597dc6c4d4db9))
* document naming conventions & aliases ([#1358](https://github.com/Mu-L/rivet/issues/1358)) ([c23e5f8](https://github.com/Mu-L/rivet/commit/c23e5f8c219a660f803a3af7b634f0b8222bccf8))
* don't query prometheus if disabled ([#1369](https://github.com/Mu-L/rivet/issues/1369)) ([e0d2b98](https://github.com/Mu-L/rivet/commit/e0d2b98f2cc9b13e1abf4b036ab78135b6c829b7))
* downgrate workflow logs to debug ([#1367](https://github.com/Mu-L/rivet/issues/1367)) ([a7dafa6](https://github.com/Mu-L/rivet/commit/a7dafa68b41fafcb85af64f8ad454274b38914c4))
* **ds:** fix started_at server conversion ([#1073](https://github.com/Mu-L/rivet/issues/1073)) ([ec498fb](https://github.com/Mu-L/rivet/commit/ec498fb4a26564326d8f3185790890d3767e3153))
* **ds:** split up destroy wf + add progress msg ([#1072](https://github.com/Mu-L/rivet/issues/1072)) ([fb3168b](https://github.com/Mu-L/rivet/commit/fb3168b11b9036286269a7c71139ee515e60a035))
* enable batch ssh commands ([#1119](https://github.com/Mu-L/rivet/issues/1119)) ([505c09c](https://github.com/Mu-L/rivet/commit/505c09cd7b74db003324c5f283638fbfb8acc4b8))
* expose s3 endpoint publicly for docker compose ([#1319](https://github.com/Mu-L/rivet/issues/1319)) ([6108a95](https://github.com/Mu-L/rivet/commit/6108a9580a969cc0757d39110349cff4ac37af06))
* fail fast on service initialization ([#1264](https://github.com/Mu-L/rivet/issues/1264)) ([970cd9d](https://github.com/Mu-L/rivet/commit/970cd9d2bbfd13836f7c4c4a6b054c730ee82c45))
* fallback to server error handler for servers ([#1266](https://github.com/Mu-L/rivet/issues/1266)) ([a4f625f](https://github.com/Mu-L/rivet/commit/a4f625f75a29d6eae31a7148a4600efcbac85d45))
* **fern:** update fern ([#1022](https://github.com/Mu-L/rivet/issues/1022)) ([e6fe279](https://github.com/Mu-L/rivet/commit/e6fe2795489653d2a328417f5b72b65dbcde7a33))
* finalize pegboard env ([#1420](https://github.com/Mu-L/rivet/issues/1420)) ([e51f3ed](https://github.com/Mu-L/rivet/commit/e51f3ed821e14a6d39a2dc8ee0856acb2fe195b4))
* fix & fmt ([#1343](https://github.com/Mu-L/rivet/issues/1343)) ([73f4b4e](https://github.com/Mu-L/rivet/commit/73f4b4e40693a1fe6dc4321cbcce7dbee71ddcd2))
* fix allowed deps ([#1337](https://github.com/Mu-L/rivet/issues/1337)) ([b1b95d8](https://github.com/Mu-L/rivet/commit/b1b95d813dd4c245cada277ab6473ab7541c2cf5))
* fix compile errors ([#1427](https://github.com/Mu-L/rivet/issues/1427)) ([ad47c71](https://github.com/Mu-L/rivet/commit/ad47c717bff4f43ab6ab080f325706d455685290))
* fix dev clickhouse migrations & storage engine ([#1350](https://github.com/Mu-L/rivet/issues/1350)) ([e6021cc](https://github.com/Mu-L/rivet/commit/e6021cca636f74eb700377d1d4d1a1d7737a7441))
* fix dynamic servers merge ([#1007](https://github.com/Mu-L/rivet/issues/1007)) ([07c4a75](https://github.com/Mu-L/rivet/commit/07c4a75741892ff1df1c227ce1c4da2affbd16d1))
* fix incorrect cron syntax ([#1286](https://github.com/Mu-L/rivet/issues/1286)) ([9e6726a](https://github.com/Mu-L/rivet/commit/9e6726af6cac33df1565e69acaf6eab232b2004a))
* fix license ([#1406](https://github.com/Mu-L/rivet/issues/1406)) ([e319fe0](https://github.com/Mu-L/rivet/commit/e319fe075eb2698ac42f3356c90917346ec89c7d))
* fix lints ([#1342](https://github.com/Mu-L/rivet/issues/1342)) ([a7e2e49](https://github.com/Mu-L/rivet/commit/a7e2e493ef308afe31bde0b51dfacae9930b13d3))
* fix loading config in tests ([#1238](https://github.com/Mu-L/rivet/issues/1238)) ([de562cb](https://github.com/Mu-L/rivet/commit/de562cb0e792faba6c97e5dbe83f9a3d27ed997f))
* fix merge bugs ([#1354](https://github.com/Mu-L/rivet/issues/1354)) ([c0d097d](https://github.com/Mu-L/rivet/commit/c0d097dfd0d5d0f0409561f82d09c8358502a99e))
* fix monolith worker out of date ([#1055](https://github.com/Mu-L/rivet/issues/1055)) ([387ee6b](https://github.com/Mu-L/rivet/commit/387ee6b5149226c81c03472d110600691edcb430))
* fix protocol for clickhouse http ([#1359](https://github.com/Mu-L/rivet/issues/1359)) ([6a8189a](https://github.com/Mu-L/rivet/commit/6a8189a440a9ae5a2b6a388c4b975d5044f8829d))
* gracefully handle returning servers when dns not configured ([#1334](https://github.com/Mu-L/rivet/issues/1334)) ([c7ec0af](https://github.com/Mu-L/rivet/commit/c7ec0af8f82c6b2b68185e83a49be0d1a45e6eb7))
* group better uptime monitors ([#972](https://github.com/Mu-L/rivet/issues/972)) ([f57ba69](https://github.com/Mu-L/rivet/commit/f57ba693218065966945914649a6a684e9fad1fe))
* handle game version configs with bad proto migrations ([#926](https://github.com/Mu-L/rivet/issues/926)) ([853cf06](https://github.com/Mu-L/rivet/commit/853cf068d920e142a25994b7a4f824ecc05e762f))
* hard crash on fail to bind server ([#1268](https://github.com/Mu-L/rivet/issues/1268)) ([e7da3c0](https://github.com/Mu-L/rivet/commit/e7da3c067581f7c70b972eee2297c2bbcfb6f4c8))
* impelment vector-client & vector-server configs, add support for dns addresses for vector ([#1351](https://github.com/Mu-L/rivet/issues/1351)) ([6f1faf7](https://github.com/Mu-L/rivet/commit/6f1faf7850aa0c8208675b731fd6c46e92103b9a))
* increase install timeout ([#1139](https://github.com/Mu-L/rivet/issues/1139)) ([38584c9](https://github.com/Mu-L/rivet/commit/38584c92f6f7b879070d63e43d46fbf8d7d34242))
* increase min crdb connections for dev ([#1348](https://github.com/Mu-L/rivet/issues/1348)) ([2f06756](https://github.com/Mu-L/rivet/commit/2f06756a9444db3381453d33da1843d20206fe33))
* increase nomad heartbeat ttl ([#1140](https://github.com/Mu-L/rivet/issues/1140)) ([437494a](https://github.com/Mu-L/rivet/commit/437494ab658889543f886082355c8a68767ed54c))
* increase sql conn acquire rate limits ([#915](https://github.com/Mu-L/rivet/issues/915)) ([deca712](https://github.com/Mu-L/rivet/commit/deca712ddecf91fb3713c31669de4aaf6ca88109))
* increase ttl of public tokens ([#905](https://github.com/Mu-L/rivet/issues/905)) ([93e705c](https://github.com/Mu-L/rivet/commit/93e705c9a8373e52b7d4f5f3d6f37058daa330c7))
* increase workflow tick interval ([#941](https://github.com/Mu-L/rivet/issues/941)) ([fb75556](https://github.com/Mu-L/rivet/commit/fb75556fd902bbdcd558e1dc6a326e32607b1d53))
* **infra:** move cdn to api-traefik-provider ([#857](https://github.com/Mu-L/rivet/issues/857)) ([9370e9e](https://github.com/Mu-L/rivet/commit/9370e9ef5a5a79bbfa460bcabd7831f3c3755feb))
* **infra:** pin k3d image version ([#975](https://github.com/Mu-L/rivet/issues/975)) ([088e05e](https://github.com/Mu-L/rivet/commit/088e05e4ffa9724b437a2b043631ca036cfcb123))
* **k3d:** disable volumes if using use_local_repo ([#954](https://github.com/Mu-L/rivet/issues/954)) ([c375325](https://github.com/Mu-L/rivet/commit/c3753254ed2cd066a5705f8d3a87eceb4c7c5b53))
* **linode:** pin kernel version ([#1123](https://github.com/Mu-L/rivet/issues/1123)) ([48686f7](https://github.com/Mu-L/rivet/commit/48686f7cad56aa5ed35d1657a4957d43781dc7d3))
* **main:** release 24.4.1 ([#861](https://github.com/Mu-L/rivet/issues/861)) ([885f8dc](https://github.com/Mu-L/rivet/commit/885f8dccc4e5db1c763233a8af38b420d90acab4))
* **main:** release 24.5.0 ([#1103](https://github.com/Mu-L/rivet/issues/1103)) ([7652421](https://github.com/Mu-L/rivet/commit/7652421cb2083de84413c1c2fccb1ac0f83ff118))
* **main:** release 24.5.0 ([#897](https://github.com/Mu-L/rivet/issues/897)) ([a5d98e3](https://github.com/Mu-L/rivet/commit/a5d98e366ce5d3947ed2534daec32c74dbc43711))
* **main:** release 24.5.1 ([#1117](https://github.com/Mu-L/rivet/issues/1117)) ([c4a6cc9](https://github.com/Mu-L/rivet/commit/c4a6cc94b5b592882d7324da37eee9fbf2dc3a8a))
* **main:** release 24.5.2 ([#1126](https://github.com/Mu-L/rivet/issues/1126)) ([6fe30fa](https://github.com/Mu-L/rivet/commit/6fe30fa75100f8db5635686dac557bf929c35504))
* make actor create runtime optional & fix inconsistent snake case in api ([#1494](https://github.com/Mu-L/rivet/issues/1494)) ([f260ab5](https://github.com/Mu-L/rivet/commit/f260ab5612ee1a05bc8153086891a774ed29824b))
* make logs query consistent with nanoseconds ([#862](https://github.com/Mu-L/rivet/issues/862)) ([4ffab51](https://github.com/Mu-L/rivet/commit/4ffab516e794ff2d53dcfe58bacce8199efe8b78))
* merge rivet-gg/site in to docs/ folder ([#1250](https://github.com/Mu-L/rivet/issues/1250)) ([dc823b6](https://github.com/Mu-L/rivet/commit/dc823b691d98eb4f993ad805efea18c3ebfed469))
* merge toolchain in to monorepo ([#1501](https://github.com/Mu-L/rivet/issues/1501)) ([904c584](https://github.com/Mu-L/rivet/commit/904c58447d306b858c864241f42dad3dd02bfdcc))
* migrate from game service to env service tokens ([#1054](https://github.com/Mu-L/rivet/issues/1054)) ([2bf6db2](https://github.com/Mu-L/rivet/commit/2bf6db2c9de45d86926ab600dedc591713cc26fc))
* migrate servers to use envs ([#1053](https://github.com/Mu-L/rivet/issues/1053)) ([6b50e9e](https://github.com/Mu-L/rivet/commit/6b50e9e7bc7fbea870ba619b9fe029ffb03b2cb3))
* migrate to seaweedfs ([#1263](https://github.com/Mu-L/rivet/issues/1263)) ([3f8dbf0](https://github.com/Mu-L/rivet/commit/3f8dbf08f0e0e3d511b16c05ae10fc4f0c77dc42))
* migrate to workspace package config ([#1399](https://github.com/Mu-L/rivet/issues/1399)) ([b9969f1](https://github.com/Mu-L/rivet/commit/b9969f1357ac7a98d32a0a51ea4fc9e9e01c58bb))
* misc ([#1200](https://github.com/Mu-L/rivet/issues/1200)) ([bebc9bf](https://github.com/Mu-L/rivet/commit/bebc9bf66ce3f56936b517b9d0e5458b6be9b655))
* misc fixes ([#1224](https://github.com/Mu-L/rivet/issues/1224)) ([0bea10f](https://github.com/Mu-L/rivet/commit/0bea10f7638446dca91b3ee1fc2c7a1e81254aa0))
* move bolt cli ([#1216](https://github.com/Mu-L/rivet/issues/1216)) ([f8ba24d](https://github.com/Mu-L/rivet/commit/f8ba24d31daa0733fa10ae45fcc2664616f45a6e))
* move crons to use native cron type ([#1272](https://github.com/Mu-L/rivet/issues/1272)) ([15eb44b](https://github.com/Mu-L/rivet/commit/15eb44b2ec349ec1f635518c6e17e620886d801f))
* move docs-old -&gt; docs-internal ([#1344](https://github.com/Mu-L/rivet/issues/1344)) ([39d95d0](https://github.com/Mu-L/rivet/commit/39d95d0f65d66995551fee1bfaebbf708e6aa70d))
* move docs-old to docs-internal & remove old docs ([#1345](https://github.com/Mu-L/rivet/issues/1345)) ([ece020b](https://github.com/Mu-L/rivet/commit/ece020ba9fecafb22c2370fc6b6ed242a8cb2e36))
* move env vars to config ([#1220](https://github.com/Mu-L/rivet/issues/1220)) ([d07e6f2](https://github.com/Mu-L/rivet/commit/d07e6f2d544cf0f48e06d05f2df9393a05c8a46e))
* move errors/ to lib/formatted-errors/errorsf ([#1244](https://github.com/Mu-L/rivet/issues/1244)) ([a34e69e](https://github.com/Mu-L/rivet/commit/a34e69ed7966d32d30b490fa8189b1d525c12aba))
* move fern to sdks folder ([#1246](https://github.com/Mu-L/rivet/issues/1246)) ([e74805d](https://github.com/Mu-L/rivet/commit/e74805df46dc8e67ef85c7e0505e07d2bcf2b90b))
* move media to subfolder ([#1245](https://github.com/Mu-L/rivet/issues/1245)) ([43c2c79](https://github.com/Mu-L/rivet/commit/43c2c79f66145aa8efa72ca91ba43d231c776f30))
* move migrate to rivet binary ([#1209](https://github.com/Mu-L/rivet/issues/1209)) ([9ba8730](https://github.com/Mu-L/rivet/commit/9ba8730a529d1e33de167a8a5937e4031b8e80ec))
* move networking config to pb clients ([#1332](https://github.com/Mu-L/rivet/issues/1332)) ([0f64653](https://github.com/Mu-L/rivet/commit/0f6465342b5b9dc32cd240e86727d4a273e38bd1))
* move pb binary urls in to cluster config ([#1309](https://github.com/Mu-L/rivet/issues/1309)) ([f638e9c](https://github.com/Mu-L/rivet/commit/f638e9cae06e64b6a5639a5e1f3fc168c0510531))
* move pegboard to container ([#1305](https://github.com/Mu-L/rivet/issues/1305)) ([edebc41](https://github.com/Mu-L/rivet/commit/edebc418ca434130a38aefeffb89e0003c30705b))
* move proto to legacy ([#1243](https://github.com/Mu-L/rivet/issues/1243)) ([ed62de3](https://github.com/Mu-L/rivet/commit/ed62de3213179b305c772e6b80bae2da1913ba3c))
* move resources/docker -&gt; docker ([#1261](https://github.com/Mu-L/rivet/issues/1261)) ([9ca338b](https://github.com/Mu-L/rivet/commit/9ca338b691f55504c347400ff52a51064f1b25b0))
* move sdk -&gt; sdk/api ([#1457](https://github.com/Mu-L/rivet/issues/1457)) ([27f0bb2](https://github.com/Mu-L/rivet/commit/27f0bb25af99fa82bcbc9a9654f090998dd7b69b))
* **pegboard:** get connection working e2e ([#1161](https://github.com/Mu-L/rivet/issues/1161)) ([f4737bb](https://github.com/Mu-L/rivet/commit/f4737bb66fd61d661547bd2cce88650e4c9c43b5))
* polish actor api ([#1357](https://github.com/Mu-L/rivet/issues/1357)) ([3c985dd](https://github.com/Mu-L/rivet/commit/3c985dd01c9b5d13a33765b496ed2d2febcf0696))
* proof v1 docs ([#1529](https://github.com/Mu-L/rivet/issues/1529)) ([a3d9ea0](https://github.com/Mu-L/rivet/commit/a3d9ea077665a5ed735ce332b9c6244d2cd6414c))
* read job-runner from ats ([#968](https://github.com/Mu-L/rivet/issues/968)) ([3fa0611](https://github.com/Mu-L/rivet/commit/3fa0611b336f45c014d550d03876412e955936ff))
* reduce chirp logging ([#1279](https://github.com/Mu-L/rivet/issues/1279)) ([a98977c](https://github.com/Mu-L/rivet/commit/a98977c1844d0443d4ea953f549235533a67330d))
* reduce startup log verbosity ([#1270](https://github.com/Mu-L/rivet/issues/1270)) ([86f5f71](https://github.com/Mu-L/rivet/commit/86f5f71d6c0d22c8cda6e46d70a8155613838909))
* release 24.4.1 ([30cc822](https://github.com/Mu-L/rivet/commit/30cc822d3511651f96dbc9e9beda445bb00d728e))
* release 24.5.0 ([1657c7c](https://github.com/Mu-L/rivet/commit/1657c7c233e73c83c70443c2e205c119ef6ee34d))
* release 24.5.1 ([12f7ee9](https://github.com/Mu-L/rivet/commit/12f7ee9e8f02c91229657292c580f4811a984518))
* release 24.5.2 ([90318ca](https://github.com/Mu-L/rivet/commit/90318ca55d19a89e68c264e507b80f2140221d73))
* remove access token ([#1311](https://github.com/Mu-L/rivet/issues/1311)) ([c6c710e](https://github.com/Mu-L/rivet/commit/c6c710e2d2c3cdd5c6066819e7107d381cd04c27))
* remove api-admin artifacts ([#1317](https://github.com/Mu-L/rivet/issues/1317)) ([742c4ba](https://github.com/Mu-L/rivet/commit/742c4bac3a5f8d4a5f3c4c81268538c58c18ad31))
* remove bolt templates ([#1135](https://github.com/Mu-L/rivet/issues/1135)) ([f0925f0](https://github.com/Mu-L/rivet/commit/f0925f0ae989c55a913e383fac43b9e5ebfa03bf))
* remove default cni network interface ([#1339](https://github.com/Mu-L/rivet/issues/1339)) ([5787f7d](https://github.com/Mu-L/rivet/commit/5787f7dea60a8bb15addb46cc2943b6859042273))
* remove devcontainer ([#1503](https://github.com/Mu-L/rivet/issues/1503)) ([9293d35](https://github.com/Mu-L/rivet/commit/9293d354ed4f04bb034137859565cf07792b7f68))
* remove duplicate smithy code ([#946](https://github.com/Mu-L/rivet/issues/946)) ([7ebe1f1](https://github.com/Mu-L/rivet/commit/7ebe1f1ea3c3622354f88637c475c4fb27f49070))
* remove excess pb-ws logs ([#1370](https://github.com/Mu-L/rivet/issues/1370)) ([861c94e](https://github.com/Mu-L/rivet/commit/861c94e283d67d618f6f81b11093029a391dbb6d))
* remove fdb from shell.nix on macos ([#1424](https://github.com/Mu-L/rivet/issues/1424)) ([bdd7ba3](https://github.com/Mu-L/rivet/commit/bdd7ba3594a522dacd5b89154170cb4639181c00))
* remove grafana & prometheus from dev setup ([#1352](https://github.com/Mu-L/rivet/issues/1352)) ([2f0187c](https://github.com/Mu-L/rivet/commit/2f0187c37e81497b0a5ce38083776b6ab0e76139))
* remove imagor reference ([#1283](https://github.com/Mu-L/rivet/issues/1283)) ([d6e3295](https://github.com/Mu-L/rivet/commit/d6e329501482a2e8ade74f543ac5bac91ed412d9))
* remove json enums ([#1151](https://github.com/Mu-L/rivet/issues/1151)) ([46dc2fc](https://github.com/Mu-L/rivet/commit/46dc2fc83684d6095c8490d1689b2c3a5240d343))
* remove remaining tf infra scripts ([#1242](https://github.com/Mu-L/rivet/issues/1242)) ([a6ccd5e](https://github.com/Mu-L/rivet/commit/a6ccd5e7ff14a44fb150809a75bc8795f82e6a4b))
* remove sccache ([#1381](https://github.com/Mu-L/rivet/issues/1381)) ([8432381](https://github.com/Mu-L/rivet/commit/843238171f451cccf27138f2872753e2683f1a59))
* remove servers webhook ([#1051](https://github.com/Mu-L/rivet/issues/1051)) ([6c6282d](https://github.com/Mu-L/rivet/commit/6c6282dba19dff87282b98b9378db695786ac8cc))
* remove submodules ([#1403](https://github.com/Mu-L/rivet/issues/1403)) ([5ee441c](https://github.com/Mu-L/rivet/commit/5ee441ca44f771d747dad4b73a140de1a2900690))
* remove unneeded nix configs ([#1248](https://github.com/Mu-L/rivet/issues/1248)) ([1b0d5d7](https://github.com/Mu-L/rivet/commit/1b0d5d7e638976a4dadec2e511956a1d610fa515))
* remove unneeded workflow backfill ([#1271](https://github.com/Mu-L/rivet/issues/1271)) ([5f03a98](https://github.com/Mu-L/rivet/commit/5f03a983b4099b3e3ff39ba795ba04bd6de8c431))
* remove unused fern routes ([#1282](https://github.com/Mu-L/rivet/issues/1282)) ([392e780](https://github.com/Mu-L/rivet/commit/392e7807bc37434911ea3e805b18b509de850252))
* remove unused services ([#1280](https://github.com/Mu-L/rivet/issues/1280)) ([2f332cc](https://github.com/Mu-L/rivet/commit/2f332cc0d5c36a359a2bdfee5726b46b71352185))
* remove user-presence ([#1207](https://github.com/Mu-L/rivet/issues/1207)) ([450f1ab](https://github.com/Mu-L/rivet/commit/450f1ab3860585b0fb3e1afa86e956239d4b69f0))
* rename actor stakeholder -&gt; manager ([#1336](https://github.com/Mu-L/rivet/issues/1336)) ([99b4c86](https://github.com/Mu-L/rivet/commit/99b4c86f2a06956eb041fb91a90c8354a82215b7))
* rename api sdk Rivet -&gt; RivetClient ([#1462](https://github.com/Mu-L/rivet/issues/1462)) ([e03abf4](https://github.com/Mu-L/rivet/commit/e03abf4a3388de357f66a51ff1f22c5603f17e75))
* rename api-internal -&gt; api-edge, add api-private, move admin to api-private ([#1284](https://github.com/Mu-L/rivet/issues/1284)) ([4659b2e](https://github.com/Mu-L/rivet/commit/4659b2efd6657f1c73a5bb694ceeba03b489dc6e))
* rename game_guard -&gt; rivet guard ([#1417](https://github.com/Mu-L/rivet/issues/1417)) ([76312de](https://github.com/Mu-L/rivet/commit/76312def5c625a8132cac8b14d1b0bfd2746647d))
* rename lib/types -&gt; lib/types-proto ([#986](https://github.com/Mu-L/rivet/issues/986)) ([c4d40af](https://github.com/Mu-L/rivet/commit/c4d40afa1e357f3e5eedae5f2453ebba27c470bd))
* reorg binary names for rivet-server and rivet-client ([#1308](https://github.com/Mu-L/rivet/issues/1308)) ([74c4f00](https://github.com/Mu-L/rivet/commit/74c4f00324320d79a6e69d0c00e796fbdf6b1db8))
* reorg rust packages ([#1247](https://github.com/Mu-L/rivet/issues/1247)) ([26ce993](https://github.com/Mu-L/rivet/commit/26ce9938d38ccd89e0db2b2f9b07ab2dc2c369d7))
* replace nix bolt with cargo run command ([#1214](https://github.com/Mu-L/rivet/issues/1214)) ([aaafef2](https://github.com/Mu-L/rivet/commit/aaafef2d27efb2fb5b701456a906f9eda9240f03))
* replace submodules with workspace deps ([#1402](https://github.com/Mu-L/rivet/issues/1402)) ([8fd4cce](https://github.com/Mu-L/rivet/commit/8fd4ccec95fac37cef28af4f1c793ffb96581566))
* restructure docs for actors ([#1519](https://github.com/Mu-L/rivet/issues/1519)) ([37e2ac9](https://github.com/Mu-L/rivet/commit/37e2ac958bf9e463f147d265a27596c3012d3fb1))
* return TOKEN_REVOKED if user no longer exists ([#1372](https://github.com/Mu-L/rivet/issues/1372)) ([89fe88d](https://github.com/Mu-L/rivet/commit/89fe88d076475c05481edd4927121484d7d9ce6e))
* revert new node exporter metrics ([#1118](https://github.com/Mu-L/rivet/issues/1118)) ([07b6095](https://github.com/Mu-L/rivet/commit/07b60954115ba10e324512f8b221ace507cc50df))
* run dev db migrations in parallel for faster startups ([#1341](https://github.com/Mu-L/rivet/issues/1341)) ([9210932](https://github.com/Mu-L/rivet/commit/921093229ed4d642c67b80e844bb082e97737916))
* serve hub on api ([#1258](https://github.com/Mu-L/rivet/issues/1258)) ([939b076](https://github.com/Mu-L/rivet/commit/939b07642bac7c0e266af7654c3410bceeb07995))
* serve ui from api ([#1260](https://github.com/Mu-L/rivet/issues/1260)) ([5bf95b3](https://github.com/Mu-L/rivet/commit/5bf95b33401a681530485ae4390bd1f4e32032a1))
* **servers:** increase rate limit ([#1194](https://github.com/Mu-L/rivet/issues/1194)) ([c265a37](https://github.com/Mu-L/rivet/commit/c265a373a0bb546c1cc462eede49af28c9e28aad))
* standardize licenses ([#1338](https://github.com/Mu-L/rivet/issues/1338)) ([016392a](https://github.com/Mu-L/rivet/commit/016392a60561c14cf1efd15cc2105af3b312358f))
* switch back to main fern repo ([#1327](https://github.com/Mu-L/rivet/issues/1327)) ([e2d5587](https://github.com/Mu-L/rivet/commit/e2d558768b4b1edee279ce3bbf9b981ad6c0b6c0))
* switch client from openssl to rustls ([#1365](https://github.com/Mu-L/rivet/issues/1365)) ([b1d1156](https://github.com/Mu-L/rivet/commit/b1d1156c0caa83bfd0c81e79feabc9b0f801de56))
* **tls:** remove unneeded acme registration ([#953](https://github.com/Mu-L/rivet/issues/953)) ([9c2e884](https://github.com/Mu-L/rivet/commit/9c2e884015f04210e642780b8bc1c396d0d7f26c))
* traffic-server forward script ([#909](https://github.com/Mu-L/rivet/issues/909)) ([a3528db](https://github.com/Mu-L/rivet/commit/a3528db07bfac20a68b845e3650c960ae960bad2))
* tweak pb manager logs ([#1377](https://github.com/Mu-L/rivet/issues/1377)) ([af7a67b](https://github.com/Mu-L/rivet/commit/af7a67bdcf528ed977e1b7581930cefebb749fae))
* tweak pool opts ([#1002](https://github.com/Mu-L/rivet/issues/1002)) ([74e36c0](https://github.com/Mu-L/rivet/commit/74e36c04b61675eb6b6df164a70193458a17948e))
* tweak pool opts ([#1004](https://github.com/Mu-L/rivet/issues/1004)) ([786829f](https://github.com/Mu-L/rivet/commit/786829f65bf614c4d625a788cf184d377ae02787))
* tweak release config ([#1307](https://github.com/Mu-L/rivet/issues/1307)) ([b577339](https://github.com/Mu-L/rivet/commit/b577339a6a61d76a93511c3db4ca5393f67c2956))
* update .gitattributes ([#1484](https://github.com/Mu-L/rivet/issues/1484)) ([fa3214c](https://github.com/Mu-L/rivet/commit/fa3214c4f809e5f054469125b9d85802484e2918))
* update actor api ([#1306](https://github.com/Mu-L/rivet/issues/1306)) ([551821a](https://github.com/Mu-L/rivet/commit/551821ad26255e574770775858693ec9cbcc599a))
* update all uses of workflows to new syntax ([#1108](https://github.com/Mu-L/rivet/issues/1108)) ([0079be8](https://github.com/Mu-L/rivet/commit/0079be80559487bbbe2c1b2bd52e797ac3e0cd05))
* update bolt with new service definition ([#1211](https://github.com/Mu-L/rivet/issues/1211)) ([6208bc2](https://github.com/Mu-L/rivet/commit/6208bc2d47935b7e50a8124f9f51d899ddbbb5c6))
* update default pb config to match new structure ([#1340](https://github.com/Mu-L/rivet/issues/1340)) ([4973a45](https://github.com/Mu-L/rivet/commit/4973a459cbcbb7c3fcaa6b6abfae1662ea4faba3))
* update dev-full restart policy to unless-stopped ([#1500](https://github.com/Mu-L/rivet/issues/1500)) ([94ff2d8](https://github.com/Mu-L/rivet/commit/94ff2d8cb913709f7e52a9031b2d8073fc8c7ab6))
* update manual e2e test for regions ([#1361](https://github.com/Mu-L/rivet/issues/1361)) ([1ce77ec](https://github.com/Mu-L/rivet/commit/1ce77ec08f22a48f04c4e7c14f207743774f490e))
* update opengb -&gt; backend rename ([#1049](https://github.com/Mu-L/rivet/issues/1049)) ([a5febc2](https://github.com/Mu-L/rivet/commit/a5febc2e80bfbe863b980c3385d365f61a7cd72e))
* update opengb cf worker names ([#1064](https://github.com/Mu-L/rivet/issues/1064)) ([904c024](https://github.com/Mu-L/rivet/commit/904c02487438008917fba50c49a754dd77cf4539))
* update start_ts to be set when networking is ready ([#1062](https://github.com/Mu-L/rivet/issues/1062)) ([22b3fec](https://github.com/Mu-L/rivet/commit/22b3fecf0ffa8f1cf10661ebf930ff78fc83f269))
* update typescript sdk ([#1031](https://github.com/Mu-L/rivet/issues/1031)) ([0e6d5fb](https://github.com/Mu-L/rivet/commit/0e6d5fb505027e4011805a4a3c154025e25ba5b7))
* update workspace ([#1030](https://github.com/Mu-L/rivet/issues/1030)) ([f738b17](https://github.com/Mu-L/rivet/commit/f738b17f5a57be369e1eee0a4a4b4b1ec9dca259))
* **workflows:** add workflow name to logs ([#928](https://github.com/Mu-L/rivet/issues/928)) ([a3b31e0](https://github.com/Mu-L/rivet/commit/a3b31e0a2a6abd4771dce8466612f29f1725344e))
* **workflows:** clean up imports ([#998](https://github.com/Mu-L/rivet/issues/998)) ([9498cab](https://github.com/Mu-L/rivet/commit/9498cab0bf47eed52459f88f11026db771fcb2a2))
* **workflows:** clean up internal contexts ([#1107](https://github.com/Mu-L/rivet/issues/1107)) ([2148f9e](https://github.com/Mu-L/rivet/commit/2148f9e4d5846eb3294dc78786b1629b8dab2110))
* **workflows:** clean up internals ([#899](https://github.com/Mu-L/rivet/issues/899)) ([b840019](https://github.com/Mu-L/rivet/commit/b84001926ef052f37cc3e1f59f50c953f9b8dfa9))
* **workflows:** remove foo pkg ([#964](https://github.com/Mu-L/rivet/issues/964)) ([7165aed](https://github.com/Mu-L/rivet/commit/7165aed53534869ff00841122e10b5e1e7ea2629))
* **workflows:** tidy up internals ([#1199](https://github.com/Mu-L/rivet/issues/1199)) ([3f0ff1e](https://github.com/Mu-L/rivet/commit/3f0ff1e3fa7ce913118672dd8f4770b8d039f6b7))
